!(function (e, t) {
  ...
  function o(e, n, i, o) {
    if (le.acceptData(e)) {
      var r,
        ...
        u = c ? le.cache : e,
        d = c ? e[a] : e[a] && a;
      if ((d && u[d] && (o || u[d].data)) || !l || i !== t)
        return (
          d || (c ? (e[a] = d = Z.pop() || le.guid++) : (d = a)),
      ...
      if (l[c]) {
        if (t && (r = n ? l[c] : l[c].data)) {
          le.isArray(t)
            ...
            : t in r
            ? (t = [t])
            : ((t = le.camelCase(t)), (t = t in r ? [t] : t.split(" ")));
    ...
    var i,
      ...
      s =
        typeof e.getElementsByTagName !== Y
          ...
          : t;
    if (!s)
      for (s = [], i = e.childNodes || e; null != (o = i[r]); r++)
  ...
  function x(e, t) {
    if (t in e) return t;
    for (
      var n = t.charAt(0).toUpperCase() + t.slice(1), i = t, o = Tt.length;
      o--;
  ...
  function k(e, t) {
    for (var n, i, o, r = [], s = 0, a = e.length; a > s; s++)
      (i = e[s]),
        i.style &&
          ((r[s] = le._data(i, "olddisplay")),
          (n = i.style.display),
          t
            ? (r[s] || "none" !== n || (i.style.display = ""),
              "" === i.style.display &&
                C(i) &&
                (r[s] = le._data(i, "olddisplay", N(i.nodeName))))
            : r[s] ||
              ((o = C(i)),
              ((n && "none" !== n) || !o) &&
                le._data(i, "olddisplay", o ? n : le.css(i, "display"))));
    for (s = 0; a > s; s++)
      (i = e[s]),
        i.style &&
  ...
  function E(e, t, n, i, o) {
    for (
      ...
      "margin" === n && (s += le.css(e, n + kt[r], !0, o)),
        i
          ? ("content" === n && (s -= le.css(e, "padding" + kt[r], !0, o)),
            "margin" !== n &&
              (s -= le.css(e, "border" + kt[r] + "Width", !0, o)))
          : ((s += le.css(e, "padding" + kt[r], !0, o)),
            "padding" !== n &&
              (s += le.css(e, "border" + kt[r] + "Width", !0, o)));
    return s;
  }
  function $(e, t, n) {
    var i = !0,
      ...
      r = ut(e),
      s =
        le.support.boxSizing && "border-box" === le.css(e, "boxSizing", !1, r);
    if (0 >= o || null == o) {
      if (
        ((o = dt(e, t, r)),
  ...
  function S(e, t, n, i) {
    ...
    if (le.isArray(t))
      le.each(t, function (t, o) {
        n || $t.test(e)
          ? i(e, o)
          : S(e + "[" + ("object" == typeof o ? t : "") + "]", o, n, i);
      });
    else if (n || "object" !== le.type(t)) i(e, t);
    else for (o in t) S(e + "[" + o + "]", t[o], n, i);
  }
  function D(e) {
    return function (t, n) {
  ...
  function H(e, t) {
    le.each(t, function (t, n) {
      for (
        var i = (rn[t] || []).concat(rn["*"]), o = 0, r = i.length;
        r > o;
        o++
      )
  ...
  function W(e, t, n) {
    ...
    n.queue ||
      ...
      1 === e.nodeType &&
        ...
        "inline" === le.css(e, "display") &&
          "none" === le.css(e, "float") &&
          (le.support.inlineBlockNeedsLayout && "inline" !== N(e.nodeName)
            ? (h.zoom = 1)
    ...
    for (o in t)
      if (((s = t[o]), en.exec(s))) {
        if (
          (delete t[o], (l = l || "toggle" === s), s === (g ? "hide" : "show"))
        )
          continue;
        m.push(o);
      }
    if ((r = m.length)) {
      ...
      for (o = 0; r > o; o++)
        (i = m[o]),
          (c = p.createTween(i, g ? a[i] : 0)),
          (f[i] = a[i] || le.style(e, i)),
          i in a ||
            ((a[i] = c.start),
            g &&
              ((c.end = c.start),
  ...
  function B(e, t) {
    ...
    for (t = t ? 1 : 0; 4 > o; o += 2 - t)
      (n = kt[o]), (i["margin" + n] = i["padding" + n] = e);
  ...
  var U,
    ...
    Ce = function () {
      Q.addEventListener
        ? (Q.removeEventListener("DOMContentLoaded", xe, !1),
          e.removeEventListener("load", xe, !1))
        : (Q.detachEvent("onreadystatechange", xe),
  ...
  (le.fn = le.prototype =
        ...
        if ("string" == typeof e) {
          ...
          if (o[1]) {
            if (
              ...
              he.test(o[1]) && le.isPlainObject(n))
            )
              for (o in n)
    ...
    le.extend({
      noConflict: function (t) {
        return (
          e.$ === le && (e.$ = V), t && e.jQuery === le && (e.jQuery = G), le
        );
      },
      isReady: !1,
      readyWait: 1,
      ...
      parseJSON: function (t) {
        return e.JSON && e.JSON.parse
          ...
          : "string" == typeof t &&
            ((t = le.trim(t)),
            t && fe.test(t.replace(ge, "@").replace(ve, "]").replace(me, "")))
      ...
      map: function (e, t, i) {
        ...
        if (a)
          for (; s > r; r++)
            (o = t(e[r], r, i)), null != o && (l[l.length] = o);
    ...
    (le.ready.promise = function (t) {
      if (!U)
        if (((U = le.Deferred()), "complete" === Q.readyState))
          setTimeout(le.ready);
        else if (Q.addEventListener)
          Q.addEventListener("DOMContentLoaded", xe, !1),
  ...
  (le.Callbacks = function (e) {
    ...
    var n,
      ...
      d = function (t) {
        for (
          o = e.memory && t, r = !0, a = l || 0, l = 0, s = c.length, n = !0;
          c && s > a;
          a++
        )
            ...
            !(function i(t) {
              le.each(t, function (t, n) {
                ...
                "function" === o
                  ...
                  : n && n.length && "string" !== o && i(n);
              });
            })(arguments),
              n ? (s = c.length) : o && ((l = t), d(o));
          }
          return this;
        },
        remove: function () {
        ...
        le(function () {
          ...
          s &&
            ...
            e.getComputedStyle &&
              ...
              (i.style.cssText = d.style.cssText = r),
              (i.style.marginRight = i.style.width = "0"),
              (d.style.width = "1px"),
              (t.reliableMarginRight = !parseFloat(
                (e.getComputedStyle(i, null) || {}).marginRight
              ))),
            typeof d.style.zoom !== Y &&
              ((d.innerHTML = ""),
              (d.style.cssText =
  ...
  le.extend({
    ...
    hasData: function (e) {
      return (
        (e = e.nodeType ? le.cache[e[le.expando]] : e[le.expando]), !!e && !a(e)
      );
    },
    data: function (e, t, n) {
      return o(e, t, n);
    ...
    le.fn.extend({
      data: function (e, n) {
        ...
        if (e === t) {
          if (
            this.length &&
            ((l = le.data(r)), 1 === r.nodeType && !le._data(r, "parsedAttrs"))
          ) {
            for (i = r.attributes; a < i.length; a++)
              (o = i[a].name),
                o.indexOf("data-") ||
                  ((o = le.camelCase(o.slice(5))), s(r, o, l[o]));
  ...
  le.fn.extend({
      ...
      if (l)
        for (t = (e || "").match(ue) || []; a > s; s++)
          if (
            ...
            (i =
              1 === n.nodeType &&
              (n.className ? (" " + n.className + " ").replace(_e, " ") : " ")))
          ) {
            for (r = 0; (o = t[r++]); )
              i.indexOf(" " + o + " ") < 0 && (i += o + " ");
      ...
      return this.each(
        le.isFunction(e)
          ...
          : function () {
              if ("string" === n)
                for (
                  var o, r = 0, s = le(this), a = t, l = e.match(ue) || [];
                  (o = l[r++]);
    ...
    hasClass: function (e) {
      for (var t = " " + e + " ", n = 0, i = this.length; i > n; n++)
        if (
          1 === this[n].nodeType &&
          (" " + this[n].className + " ").replace(_e, " ").indexOf(t) >= 0
        )
          return !0;
      return !1;
    },
          ...
          return (
            ...
            this.each(function (n) {
              ...
              1 === this.nodeType &&
                ...
                (i && "set" in i && i.set(this, r, "value") !== t) ||
                  (this.value = r));
            })
          );
        if (r)
          return (
            (i = le.valHooks[r.type] || le.valHooks[r.nodeName.toLowerCase()]),
            i && "get" in i && (n = i.get(r, "value")) !== t
              ? n
              : ((n = r.value),
        ...
        if (e && 3 !== a && 8 !== a && 2 !== a)
          return typeof e.getAttribute === Y
            ...
            : ((r = 1 !== a || !le.isXMLDoc(e)),
              r &&
                ((n = n.toLowerCase()),
                (o = le.attrHooks[n] || (Me.test(n) ? Ne : $e))),
              i === t
                ? o && r && "get" in o && null !== (s = o.get(e, n))
                  ? s
                  : (typeof e.getAttribute !== Y && (s = e.getAttribute(n)),
                    null == s ? t : s)
                : null !== i
                ? o && r && "set" in o && (s = o.set(e, i, n)) !== t
                  ? s
      ...
      prop: function (e, n, i) {
        ...
        if (e && 3 !== a && 8 !== a && 2 !== a)
          return (
            ...
            i !== t
              ? r && "set" in r && (o = r.set(e, i, n)) !== t
                ? o
                : (e[n] = i)
              : r && "get" in r && null !== (o = r.get(e, n))
              ? o
              : e[n]
          );
      },
        ...
        tabIndex: {
          get: function (e) {
            ...
            return n && n.specified
              ? parseInt(n.value, 10)
              : De.test(e.nodeName) || (Ae.test(e.nodeName) && e.href)
              ? 0
              : t;
          },
        },
      ...
      set: function (e, t, n) {
        return (
          t === !1
            ? le.removeAttr(e, n)
            : (Fe && Pe) || !Le.test(n)
            ? e.setAttribute((!Pe && le.propFix[n]) || n, n)
    ...
    le.each(["radio", "checkbox"], function () {
      le.valHooks[this] = le.extend(le.valHooks[this], {
        set: function (e, t) {
          return le.isArray(t)
            ? (e.checked = le.inArray(le(e).val(), t) >= 0)
            : void 0;
        },
      });
    });
  ...
  (le.event = {
        ...
        for (
          i.handler && ((c = i), (i = c.handler), (r = c.selector)),
            ...
            (d = v.handle) ||
              ((d = v.handle =
                function (e) {
                  return typeof le === Y || (e && le.event.triggered === e.type)
                    ? t
          ...
          (s = ze.exec(n[l]) || []),
            ...
            (h = a[f]) ||
              ((h = a[f] = []),
              (h.delegateCount = 0),
              (u.setup && u.setup.call(e, o, m, d) !== !1) ||
                (e.addEventListener
          ...
          if (
            ...
            l &&
              ...
              ((d.teardown && d.teardown.call(e, f, g.handle) !== !1) ||
                le.removeEvent(e, h, g.handle),
              delete u[h]);
          } else for (h in u) le.event.remove(e, h + t[c], n, i, !0);
    ...
    trigger: function (n, i, o, r) {
      ...
      if (
        ...
        3 !== o.nodeType &&
          8 !== o.nodeType &&
          !je.test(f + le.event.triggered) &&
          (f.indexOf(".") >= 0 &&
            ((m = f.split(".")), (f = m.shift()), m.sort()),
          (a = f.indexOf(":") < 0 && "on" + f),
          (n = n[le.expando] ? n : new le.Event(f, "object" == typeof n && n)),
          (n.isTrigger = !0),
          (n.namespace = m.join(".")),
        ...
        if (!r && !u.noBubble && !le.isWindow(o)) {
          for (
            c = u.delegateType || f, je.test(c + f) || (l = l.parentNode);
            l;
            l = l.parentNode
          )
            h.push(l), (d = l);
        ...
        if (
          ...
          !(
            ...
            (u._default && u._default.apply(o.ownerDocument, i) !== !1) ||
            ("click" === f && le.nodeName(o, "a")) ||
            !le.acceptData(o) ||
            !a ||
            !o[f] ||
            le.isWindow(o)
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          a = le.event.handlers.call(this, e, c), n = 0;
    ...
    fix: function (e) {
      ...
      for (
        s ||
          (this.fixHooks[o] = s =
            He.test(o) ? this.mouseHooks : Ie.test(o) ? this.keyHooks : {}),
        ...
        (n = i[t]), (e[n] = r[n]);
      return (
        e.target || (e.target = r.srcElement || Q),
    ...
    special: {
      ...
      blur: {
        trigger: function () {
          return this === Q.activeElement && this.blur
            ? (this.blur(), !1)
            : void 0;
        },
    ...
    (le.removeEvent = Q.removeEventListener
      ...
      : function (e, t, n) {
          var i = "on" + t;
          e.detachEvent &&
            (typeof e[i] === Y && (e[i] = null), e.detachEvent(i, n));
        }),
        ...
        if (!L && !i) {
          if ((o = me.exec(e)))
            if ((s = o[1])) {
              ...
              if (o[2])
                return V.apply(n, J.call(t.getElementsByTagName(e), 0)), n;
              if ((s = o[3]) && W.getByClassName && t.getElementsByClassName)
                return V.apply(n, J.call(t.getElementsByClassName(s), 0)), n;
            }
          if (W.qsa && !P.test(e)) {
            if (
              ((u = !0),
        ...
        return (
          ...
          o(function (o, s, a, l) {
            var c,
              ...
              y = n ? (r || (o ? e : f || i) ? [] : s) : v;
            if ((n && n(v, y, a, l), i))
              for (c = m(y, h), i(c, [], a, l), u = c.length; u--; )
                (d = c[u]) && (y[h[u]] = !(v[h[u]] = d));
            if (o) {
              if (r || e) {
                if (r) {
        ...
        for (
          ...
          if ((n = T.relative[e[a].type])) u = [h(f(u), n)];
            ...
            if (((n = T.filter[e[a].type].apply(null, e[a].matches)), n[j])) {
              ...
              return g(
                a > 1 && f(u),
                a > 1 && p(e.slice(0, a - 1)).replace(se, "$1"),
                n,
                i > a && v(e.slice(a, i)),
                o > i && v((e = e.slice(i))),
                o > i && p(e)
        ...
        var n = 0,
          ...
          a = function (o, a, l, c, u) {
            ...
            if (((g += v), i && v !== g)) {
              ...
              V.apply(c, f),
                b && !o && f.length > 0 && g + t.length > 1 && s.uniqueSort(c);
            }
            return b && ((R = C), (S = w)), y;
          };
        return i ? o(a) : a;
      ...
      function w(e, t, n, i) {
        ...
        if (!i && 1 === c.length) {
          if (
            ...
            if (((t = T.find.ID(s.matches[0].replace(we, xe), t)[0]), !t))
              return n;
          ...
          for (
            ...
            if (
              ...
              (i = l(
                ...
                (he.test(r[0].type) && t.parentNode) || t
              ))
            ) {
              if ((r.splice(o, 1), (e = i.length && p(r)), !e))
                return V.apply(n, J.call(i, 0)), n;
              break;
            }
        }
      ...
      ($ = s.isXML =
            ...
            return i !== A && 9 === i.nodeType && i.documentElement
              ? ((A = i),
                ...
                (W.getByName = r(function (e) {
                  (e.id = j + 0),
                    (e.innerHTML =
                      "<a name='" + j + "'></a><div name='" + j + "'></div>"),
                    M.insertBefore(e, M.firstChild);
                  var t =
                    i.getElementsByName &&
                    i.getElementsByName(j).length ===
                      2 + i.getElementsByName(j + 0).length;
                  return (
                    (W.getIdNotName = !i.getElementById(j)), M.removeChild(e), t
                  );
                })),
                ...
                (T.find.TAG = W.tagNameNoComments
                  ? function (e, t) {
                ...
                (T.find.NAME =
                  W.getByName &&
                  function (e, t) {
                    return typeof t.getElementsByName !== Y
                ...
                (T.find.CLASS =
                  W.getByClassName &&
                  function (e, t) {
                    return typeof t.getElementsByClassName === Y || L
                      ? void 0
                      : t.getElementsByClassName(e);
                  }),
                (F = []),
                (P = [":focus"]),
                (W.qsa = n(i.querySelectorAll)) &&
                  (r(function (e) {
                    (e.innerHTML =
                ...
                (F = new RegExp(F.join("|"))),
                (I =
                  n(M.contains) || M.compareDocumentPosition
                    ? function (e, t) {
        ...
        (s.matchesSelector = function (e, t) {
          if (
            ...
            (t = t.replace(be, "='$1']")),
            !(!W.matchesSelector || L || (F && F.test(t)) || P.test(t)))
          )
            try {
              var n = O.call(e, t);
              if (
        ...
        (T = s.selectors =
          {
            ...
            pseudos: {
              ...
              lang: o(function (e) {
                return (
                  de.test(e || "") || s.error("unsupported lang: " + e),
                  (e = e.replace(we, xe).toLowerCase()),
                  function (t) {
                    var n;
                    do
  ...
  le.fn.extend({
    find: function (e) {
      ...
      return (
        (n = this.pushStack(o > 1 ? le.unique(n) : n)),
    ...
    closest: function (e, t) {
      for (
        var n,
          ...
          o = this.length,
          r = [],
          s = qe.test(e) || "string" != typeof e ? le(e, t || this.context) : 0;
        o > i;
        i++
      )
        for (
      ...
      function (e, t) {
        le.fn[e] = function (n, i) {
          ...
          return (
            ...
            this.length > 1 && Re.test(e) && (o = o.reverse()),
            this.pushStack(o)
          );
        };
      }
  ...
  (st.optgroup = st.option),
    ...
    le.fn.extend({
          ...
          function (e) {
            ...
            if (
              !(
                ...
                (!le.support.leadingWhitespace && Ke.test(e)) ||
                st[(Ve.exec(e) || ["", ""])[1].toLowerCase()]
              )
            ) {
              e = e.replace(Ge, "<$1></$2>");
              try {
      ...
      domManip: function (e, n, i) {
        ...
        if (
          y ||
          (!(1 >= d || "string" != typeof v || le.support.checkClone) &&
            nt.test(v))
        )
        ...
        if (
          ...
          for (
            n = n && le.nodeName(o, "tr"),
              a = le.map(b(c, "script"), f),
              s = a.length;
            d > u;
            u++
          )
            (r = c),
              u !== g &&
                ((r = le.clone(r, !0, !0)), s && le.merge(a, b(r, "script"))),
              i.call(
          ...
          if (s)
            for (
              l = a[a.length - 1].ownerDocument, le.map(a, m), u = 0;
              s > u;
              u++
            )
              (r = a[u]),
                it.test(r.type || "") &&
                  !le._data(r, "globalEval") &&
                  le.contains(l, r) &&
                  (r.src
                    ? le.ajax({
                        url: r.src,
    ...
    le.extend({
      clone: function (e, t, n) {
        ...
        if (
          ...
          for (i = b(r), a = b(e), s = 0; null != (o = a[s]); ++s)
            i[s] && y(o, i[s]);
        if (t)
          if (n)
            for (a = a || b(e), i = i || b(r), s = 0; null != (o = a[s]); s++)
              v(o, i[s]);
          else v(e, r);
        return (
          (i = b(r, "script")),
          i.length > 0 && g(i, !l && b(e, "script")),
          (i = a = o = null),
          r
        );
      },
      buildFragment: function (e, t, n, i) {
        for (
          var o, r, s, a, l, c, u, d = e.length, h = p(t), f = [], m = 0;
          d > m;
          m++
        )
          if (((r = e[m]), r || 0 === r))
            if ("object" === le.type(r)) le.merge(f, r.nodeType ? [r] : r);
              ...
              for (
                a = a || h.appendChild(t.createElement("div")),
                  ...
                  u = st[l] || st._default,
                  a.innerHTML = u[1] + r.replace(Ge, "<$1></$2>") + u[2],
                  o = u[0];
                o--;
              ...
              if (
                (!le.support.leadingWhitespace &&
                  Ke.test(r) &&
                  f.push(t.createTextNode(Ke.exec(r)[0])),
                !le.support.tbody)
              )
                for (
                  r =
                  ...
                  le.nodeName((c = r.childNodes[o]), "tbody") &&
                    !c.childNodes.length &&
                    r.removeChild(c);
              for (
                le.merge(f, a.childNodes), a.textContent = "";
                a.firstChild;
        ...
        for (
          a && h.removeChild(a),
            le.support.appendChecked || le.grep(b(f, "input"), w),
            m = 0;
          (r = f[m++]);
          ...
          if (
            (!i || -1 === le.inArray(r, i)) &&
            ((s = le.contains(r.ownerDocument, r)),
            (a = b(h.appendChild(r), "script")),
            s && g(a),
            n)
          )
      ...
      cleanData: function (e, t) {
        for (
          ...
          if ((t || le.acceptData(n)) && ((o = n[a]), (r = o && l[o]))) {
            if (r.events)
              for (i in r.events)
                u[i] ? le.event.remove(n, i) : le.removeEvent(n, i, r.handle);
            l[o] &&
              (delete l[o],
              c
                ? delete n[a]
  ...
  le.fn.extend({
    ...
    le.extend({
      ...
      style: function (e, n, i, o) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          var r,
            ...
            c = e.style;
          if (
            ((n = le.cssProps[l] || (le.cssProps[l] = x(c, l))),
          ...
          if (
            ...
            "string" === s &&
              (r = bt.exec(i)) &&
              ((i = (r[1] + 1) * r[2] + parseFloat(le.css(e, n))),
              (s = "number")),
            !(
              null == i ||
              ("number" === s && isNaN(i)) ||
              ("number" !== s || le.cssNumber[l] || (i += "px"),
      ...
      css: function (e, n, i, o) {
        var r,
          ...
          l = le.camelCase(n);
        return (
          (n = le.cssProps[l] || (le.cssProps[l] = x(e.style, l))),
          (a = le.cssHooks[n] || le.cssHooks[l]),
          a && "get" in a && (s = a.get(e, !0, i)),
          s === t && (s = dt(e, n, o)),
          "normal" === s && n in Ct && (s = Ct[n]),
          "" === i || i
            ? ((r = parseFloat(s)), i === !0 || le.isNumeric(r) ? r || 0 : s)
            : s
        );
      },
    ...
    le.each(["height", "width"], function (e, t) {
      le.cssHooks[t] = {
        get: function (e, n, i) {
          return n
            ? 0 === e.offsetWidth && mt.test(le.css(e, "display"))
              ? le.swap(e, xt, function () {
                  return $(e, t, i);
                })
              : $(e, t, i)
            : void 0;
    ...
    le(function () {
      le.support.reliableMarginRight ||
        (le.cssHooks.marginRight = {
          get: function (e, t) {
            return t
              ? le.swap(e, { display: "inline-block" }, dt, [e, "marginRight"])
              : void 0;
          },
        }),
  ...
  (Dt = zt.exec(At.toLowerCase()) || []),
    (le.fn.load = function (e, n, i) {
      ...
      var o,
        ...
        l = e.indexOf(" ");
      return (
        l >= 0 && ((o = e.slice(l, e.length)), (e = e.slice(0, l))),
        le.isFunction(n)
          ? ((i = n), (n = t))
    ...
    le.each(["get", "post"], function (e, n) {
      le[n] = function (e, i, o, r) {
        return (
          le.isFunction(i) && ((r = r || o), (o = i), (i = t)),
          le.ajax({ url: e, type: n, dataType: r, data: i, success: o })
        );
      };
    }),
    le.extend({
      ...
      ajax: function (e, n) {
        function i(e, n, i, o) {
          ...
          2 !== w &&
            ...
            (C.status = e),
            (C.statusText = (n || k) + ""),
            r ? m.resolveWith(h, [d, k, C]) : m.rejectWith(h, [C, k, y]),
            C.statusCode(v),
            (v = t),
            c && f.trigger(r ? "ajaxSuccess" : "ajaxError", [C, p, r ? d : y]),
            g.fireWith(h, [C, k]),
            c &&
        ...
        (c = p.global),
          ...
          p.hasContent ||
            (p.data &&
              ((s = p.url += (Lt.test(s) ? "&" : "?") + p.data), delete p.data),
            p.cache === !1 &&
              (p.url = Ft.test(s)
                ? s.replace(Ft, "$1_=" + Mt++)
                : s + (Lt.test(s) ? "&" : "?") + "_=" + Mt++)),
          p.ifModified &&
            (le.lastModified[s] &&
              C.setRequestHeader("If-Modified-Since", le.lastModified[s]),
            le.etag[s] && C.setRequestHeader("If-None-Match", le.etag[s])),
        ...
        if (p.beforeSend && (p.beforeSend.call(h, C, p) === !1 || 2 === w))
          return C.abort();
        x = "abort";
      ...
      return l || "jsonp" === n.dataTypes[0]
        ? ((r = n.jsonpCallback =
            le.isFunction(n.jsonpCallback)
              ...
              : n.jsonpCallback),
          l
            ? (n[l] = n[l].replace(Yt, "$1" + r))
            : n.jsonp !== !1 &&
              (n.url += (Lt.test(n.url) ? "&" : "?") + n.jsonp + "=" + r),
          ...
          o.always(function () {
            (e[r] = s),
              n[r] && ((n.jsonpCallback = i.jsonpCallback), Xt.push(r)),
  ...
  (le.ajaxSettings.xhr = e.ActiveXObject
    ...
    : F),
    (Kt = le.ajaxSettings.xhr()),
    (le.support.cors = !!Kt && "withCredentials" in Kt),
    (Kt = le.support.ajax = !!Kt),
    Kt &&
              ...
              l.send((n.hasContent && n.data) || null),
                ...
                n.async
                  ? 4 === l.readyState
                    ? setTimeout(i)
                    : ((s = ++Gt),
                      Vt && (Qt || ((Qt = {}), le(e).unload(Vt)), (Qt[s] = i)),
  ...
  (le.Animation = le.extend(j, {
    tweener: function (e, t) {
      ...
      for (var n, i = 0, o = e.length; o > i; i++)
        (n = e[i]), (rn[n] = rn[n] || []), rn[n].unshift(t);
    },
    ...
    t.prototype.checkPosition = function () {
      if (this.$element.is(":visible")) {
        ...
        "object" != typeof r && (s = a = r),
          ...
          this.affixed !== t &&
            ((this.affixed = t),
            (this.unpin = "bottom" == t ? o.top - i : null),
            this.$element
              .removeClass(l)
              .addClass("affix" + (t ? "-" + t : "")));
      }
  ...
  !(function (e) {
    ...
    o.prototype = {
      ...
      keydown: function (t) {
        ...
        if (
          ...
          if (
            ((s = n(o)), (a = s.hasClass("open")), !a || (a && 27 == t.keyCode))
          )
            return 27 == t.which && s.find(i).focus(), o.click();
          (r = e("[role=menu] li:not(.divider):visible a", s)),
            r.length &&
              ((l = r.index(r.filter(":focus"))),
              38 == t.keyCode && l > 0 && l--,
              40 == t.keyCode && l < r.length - 1 && l++,
              ~l || (l = 0),
              r.eq(l).focus());
        }
      },
    ...
    (e.fn.dropdown = function (t) {
      ...
      e(document)
        ...
        .on("click.dropdown.data-api", i, o.prototype.toggle)
        .on(
      ...
      r || ((r = o.attr("href")), (r = r && r.replace(/.*(?=#[^\s]*$)/, ""))),
        ...
        t.isDefaultPrevented() ||
          ...
          e.support.transition && i.hasClass("fade")
            ? i.on(e.support.transition.end, n)
            : n());
    };
    var i = e.fn.alert;
        ...
        this.$element.trigger(n),
          n.isDefaultPrevented() ||
            ...
            e.support.transition && this.$element.hasClass("collapse")
              ? this.$element.one(e.support.transition.end, r)
              : r());
      },
      toggle: function () {
      ...
      e(document).on(
        ...
        function (t) {
          var n = e(this),
            ...
            r = o.data("modal")
              ? "toggle"
              : e.extend({ remote: !/#/.test(i) && i }, o.data(), n.data());
          t.preventDefault(),
          ...
          "bottom" == t || "top" == t
            ? ((o = 0),
              e.left < 0 &&
                ...
                (n = s[0].offsetWidth),
                (i = s[0].offsetHeight)),
              this.replaceArrow(o - a + n, n, "left"))
            : this.replaceArrow(i - l, i, "top"),
          r && s.offset(e);
      },
      ...
      show: function () {
        ...
        s || ((s = o.attr("href")), (s = s && s.replace(/.*(?=#[^\s]*$)/, ""))),
          o.parent("li").hasClass("active") ||
            ((t = r.find(".active:last a")[0]),
            (i = e.Event("show", { relatedTarget: t })),
            o.trigger(i),
            i.isDefaultPrevented() ||
              ((n = e(s)),
              this.activate(o.parent("li"), r),
  ...
  !(function (e) {
    ...
    (t.prototype = e.extend({}, e.fn.modal.Constructor.prototype)),
      ...
      (t.prototype.preloadSize = function (t) {
        ...
        (i = e(window).height()),
          (o = e(window).width()),
          (r = parseInt(
            h.$element.find(".lightbox-content").css("padding-top"),
            10
          )),
          (s = parseInt(
            h.$element.find(".lightbox-content").css("padding-bottom"),
            10
          )),
          (a = parseInt(
            h.$element.find(".lightbox-content").css("padding-left"),
            10
          )),
          (l = parseInt(
            h.$element.find(".lightbox-content").css("padding-right"),
            10
          )),
          (c = h.$element.find(".lightbox-content").find("img:first")),
          (u = new Image()),
          (u.onload = function () {
            u.width + a + l >= o &&
              ((d = u.width),
              (p = u.height),
              (u.width = o - a - l),
              (u.height = (p / d) * u.width)),
              u.height + r + s >= i &&
                ((d = u.width),
                (p = u.height),
                (u.height = i - r - s),
                (u.width = (d / p) * u.height)),
              h.$element.css({
                position: "fixed",
                width: u.width + a + l,
                height: u.height + r + s,
              ...
              h.$element
                ...
                .css({ width: u.width, height: u.height }),
              n.fire();
          }),
          (u.src = c.attr("src"));
      });
    ...
    (e.fn.lightbox = function (n) {
      return this.each(function () {
        ...
        o || i.data("lightbox", (o = new t(this, r))),
          "string" == typeof n ? o[n]() : r.show && o.show();
      });
    }),
        ...
        function (t) {
          var n = e(this),
            ...
            r = o.data("lightbox")
              ...
              : e.extend({ remote: !/#/.test(i) && i }, o.data(), n.data());
          t.preventDefault(),
            o.lightbox(r).one("hide", function () {
              n.focus();
            });
        }
      );
  ...
  (function (e, t) {
    function n(e) {
      for (var t, n = e.split(/\s+/), i = [], o = 0; (t = n[o]); o++)
        (t = t[0].toUpperCase()), i.push(t);
      return i;
    }
    function i(t) {
    ...
    function o(n, r, s) {
      return (
        ...
        r.each(function () {
          ...
          switch (
            ("label" == u &&
              l.find("input, textarea, select").length &&
              ((r = l.text()),
              (l = l.children().first()),
              (c = l.get(0)),
      ...
      m = function (e) {
        for (var t = 0, n = e; ; )
          if (
            ...
            !n ||
              !n.length ||
              "html body".indexOf(n.prop("nodeName").toLowerCase()) > -1)
          )
            break;
        return t;
      },
      g = {
        ...
        contextmenu: function (t) {
          ...
          if (
            ...
            !(
              ("right" != t.data.trigger && t.originalEvent) ||
        ...
        mousedown: function (t) {
          ...
          s &&
            s.length &&
            !s.is(n) &&
            s.data("contextMenu").$menu.trigger("contextmenu:hide"),
            2 == t.button && (s = n.data("contextMenuActive", !0));
        },
        mouseup: function (t) {
          var n = e(this);
        ...
        mouseenter: function (t) {
          var n = e(this),
            i = e(t.relatedTarget),
            o = e(document);
          i.is(".context-menu-list") ||
            i.closest(".context-menu-list").length ||
            (s && s.length) ||
            ((f.pageX = t.pageX),
            (f.pageY = t.pageY),
            (f.data = t.data),
            o.on("mousemove.contextMenuShow", g.mousemove),
            ...
            setTimeout(function () {
              ...
              if (
                ...
                if (document.elementFromPoint) {
                  if (r.$trigger.is(n) || r.$trigger.has(n).length)
                    return void r.position.call(r.$trigger, r, a, c);
                } else if (
                  ((i = r.$trigger.offset()),
                  (o = e(window)),
                  (i.top += o.scrollTop()),
                  i.top <= t.pageY &&
                    ((i.left += o.scrollLeft()),
                    i.left <= t.pageX &&
                      ((i.bottom = i.top + r.$trigger.outerHeight()),
                      i.bottom >= t.pageY &&
                        ((i.right = i.left + r.$trigger.outerWidth()),
                        i.right >= t.pageX))))
                )
                  return void r.position.call(r.$trigger, r, a, c);
              n &&
                u &&
                r.$trigger.one("contextmenu:hidden", function () {
        ...
        key: function (e) {
          ...
          switch (e.keyCode) {
            ...
            case 39:
              ...
              if (i.$menu && t.$selected.hasClass("context-menu-submenu"))
                return (
                  (t.$selected = null),
                  (i.$selected = null),
                  void i.$menu.trigger("nextcommand")
                );
              break;
            case 35:
            case 36:
            ...
            default:
              ...
              if (t.accesskeys[o])
                return void t.accesskeys[o].$node.trigger(
                  t.accesskeys[o].$menu ? "contextmenu:focus" : "mouseup"
                );
          }
        ...
        prevItem: function (t) {
          ...
          for (
            var o = n.$menu.children(),
              r =
                n.$selected && n.$selected.prev().length
                  ? n.$selected.prev()
                  : o.last(),
              s = r;
            r.hasClass("disabled") || r.hasClass("not-selectable");

          )
            if (((r = r.prev().length ? r.prev() : o.last()), r.is(s))) return;
          n.$selected && g.itemMouseleave.call(n.$selected.get(0), t),
            g.itemMouseenter.call(r.get(0), t);
        ...
        itemMouseenter: function (t) {
          ...
          return (
            ...
            t &&
              r.$layer &&
              r.$layer.is(t.relatedTarget) &&
              (t.preventDefault(), t.stopImmediatePropagation()),
            (o.$menu ? o : r).$menu
              .children(".hover")
              .trigger("contextmenu:blur"),
            n.hasClass("disabled") || n.hasClass("not-selectable")
        ...
        itemMouseleave: function (t) {
          var n = e(this),
            ...
            o = i.contextMenu,
            r = i.contextMenuRoot;
          return r !== o && r.$layer && r.$layer.is(t.relatedTarget)
            ? (r.$selected && r.$selected.trigger("contextmenu:blur"),
              t.preventDefault(),
              t.stopImmediatePropagation(),
              void (r.$selected = o.$selected = o.$node))
        ...
        itemClick: function (t) {
          ...
          if (
            ...
            if (
              (t.preventDefault(),
              t.stopImmediatePropagation(),
              e.isFunction(s.callbacks[a]) &&
                Object.prototype.hasOwnProperty.call(s.callbacks, a))
            )
              n = s.callbacks[a];
            else {
            ...
            n.call(s.$trigger, a, s) !== !1
              ? s.$menu.trigger("contextmenu:hide")
              : s.$menu.parent().length && v.update.call(s.$trigger, s);
          }
        },
        ...
        focusItem: function (t) {
          ...
          var n = e(this),
            ...
            o = i.contextMenu,
            r = i.contextMenuRoot;
          n.addClass("hover").siblings(".hover").trigger("contextmenu:blur"),
            (o.$selected = r.$selected = n),
            o.$node && r.positionSubmenu.call(o.$node, o.$menu);
        },
        blurItem: function (t) {
          t.stopPropagation();
          {
      ...
      v = {
        show: function (t, n, i) {
          ...
          return (
            ...
            (t.$trigger = o),
            t.events.show.call(o, t) === !1
              ? void (s = null)
              : (v.update.call(o, t),
                t.position.call(o, t, n, i),
                t.zIndex && (r.zIndex = m(o) + t.zIndex),
                v.layer.call(t.$menu, t, r.zIndex),
                ...
                o.data("contextMenu", t).addClass("context-menu-active"),
                e(document)
                  .off("keydown.contextMenu")
                  .on("keydown.contextMenu", g.key),
                void (
                  t.autoHide &&
                  e(document).on("mousemove.contextMenuAutoHide", function (e) {
                    var n = o.offset();
                    (n.right = n.left + o.outerWidth()),
                      (n.bottom = n.top + o.outerHeight()),
                      !t.$layer ||
                        t.hovering ||
                        (e.pageX >= n.left &&
                          e.pageX <= n.right &&
        ...
        hide: function (n, i) {
          var o = e(this);
          if (
            (n || (n = o.data("contextMenu") || {}),
            i || !n.events || n.events.hide.call(o, n) !== !1)
          ) {
            if (
              (o.removeData("contextMenu").removeClass("context-menu-active"),
              n.$layer)
            ) {
              setTimeout(
                (function (e) {
            ...
            (s = null),
              n.$menu.find(".hover").trigger("contextmenu:blur"),
              (n.$selected = null),
              e(document)
                .off(".contextMenuAutoHide")
                .off("keydown.contextMenu"),
              n.$menu &&
                n.$menu[n.animation.hide](n.animation.duration, function () {
                  n.build &&
                    (n.$menu.remove(),
        ...
        create: function (i, o) {
          o === t && (o = i),
            (i.$menu = e('<ul class="context-menu-list"></ul>')
              .addClass(i.className || "")
              .data({ contextMenu: i, contextMenuRoot: o })),
            e.each(["callbacks", "commands", "inputs"], function (e, t) {
              (i[t] = {}), o[t] || (o[t] = {});
            }),
            o.accesskeys || (o.accesskeys = {}),
            e.each(i.items, function (t, r) {
              var s = e('<li class="context-menu-item"></li>').addClass(
                  r.className || ""
                ),
                a = null,
                l = null;
              ...
              if ("string" == typeof r)
              ...
              else if (r.type && p[r.type])
                p[r.type].call(s, r, i, o),
                  e.each([i, o], function (n, i) {
                    (i.commands[t] = r),
                      e.isFunction(r.callback) && (i.callbacks[t] = r.callback);
                  });
              else {
                switch (
                  ("html" == r.type
                  ...
                  case "text":
                    l = e('<input type="text" value="1" name="" value="">')
                      .attr("name", "context-menu-input-" + t)
                      .val(r.value || "")
                      .appendTo(a);
                    break;
                  case "textarea":
                    ...
                    break;
                  case "checkbox":
                    l = e('<input type="checkbox" value="1" name="" value="">')
                      .attr("name", "context-menu-input-" + t)
                      .val(r.value || "")
                    ...
                    break;
                  case "radio":
                    l = e('<input type="radio" value="1" name="" value="">')
                      .attr("name", "context-menu-input-" + r.radio)
                      .val(r.value || "")
                      .prop("checked", !!r.selected)
                      .prependTo(a);
                    break;
                ...
                r.type &&
                  "sub" != r.type &&
                  "html" != r.type &&
                  (l.on("focus", g.focusInput).on("blur", g.blurInput),
                  r.events && l.on(r.events, i)),
                  r.icon && s.addClass("icon icon-" + r.icon);
              }
              (r.$input = l),
                (r.$label = a),
                s.appendTo(i.$menu),
                !i.hasTypes &&
                  e.support.eventSelectstart &&
                  s.on("selectstart.disableTextSelect", g.abortevent);
            }),
            i.$node ||
        ...
        update: function (n, i) {
          var o = this;
          i === t && ((i = n), v.resize(n.$menu)),
            n.$menu.children().each(function () {
              var t = e(this),
                r = t.data("contextMenuKey"),
                s = n.items[r],
                a =
                  (e.isFunction(s.disabled) && s.disabled.call(o, r, i)) ||
                  s.disabled === !0;
              if ((t[a ? "addClass" : "removeClass"]("disabled"), s.type))
                switch (
                  (t.find("input, select, textarea").prop("disabled", a),
                  s.type)
                ) {
                  case "text":
                  case "textarea":
        ...
        layer: function (t, n) {
          var i = (t.$layer = e(
            ...
            .css({ height: l.height(), width: l.width(), display: "block" })
            .data("contextMenuRoot", t)
            .insertBefore(this)
            .on("contextmenu", g.abortevent)
            .on("mousedown", g.layerClick));
          return (
            e.support.fixedPosition ||
              i.css({ position: "absolute", height: e(document).height() }),
            i
          );
        },
      };
    (e.fn.contextMenu = function (n) {
      if (n === t) this.first().trigger("contextmenu");
        ...
        this.first().trigger(
          e.Event("contextmenu", { pageX: n.x, pageY: n.y })
        );
      else if ("hide" === n) {
        ...
        "destroy" === n
          ...
          : e.isPlainObject(n)
          ? ((n.context = this), e.contextMenu("create", n))
          : n
          ? this.removeClass("context-menu-disabled")
          : n || this.addClass("context-menu-disabled");
      return this;
    }),
      (e.contextMenu = function (n, i) {
        "string" != typeof n && ((i = n), (n = "create")),
          "string" == typeof i ? (i = { selector: i }) : i === t && (i = {});
          ...
          case "create":
            ...
            switch (
              ...
              a ||
                ...
                (a = !0)),
              s.on("contextmenu" + o.ns, o.selector, o, g.contextmenu),
              l &&
                s.on("remove" + o.ns, function () {
                  e(this).contextMenu("destroy");
                }),
              o.trigger)
            ) {
              case "hover":
                s.on("mouseenter" + o.ns, o.selector, o, g.mouseenter).on(
                  "mouseleave" + o.ns,
                  o.selector,
                  o,
                  g.mouseleave
          ...
          case "destroy":
            ...
            if (l) {
              ...
              e.each(d, function (t, n) {
                ...
                (p = e(".context-menu-list").filter(":visible")),
                  p.length &&
                    p
                      .data()
                    ...
                    p.trigger("contextmenu:hide", { force: !0 });
                try {
              ...
              if (u[o.selector]) {
                (p = e(".context-menu-list").filter(":visible")),
                  p.length &&
                    p.data().contextMenuRoot.$trigger.is(o.selector) &&
                    p.trigger("contextmenu:hide", { force: !0 });
                try {
                  d[u[o.selector]].$menu && d[u[o.selector]].$menu.remove(),
                    delete d[u[o.selector]];
                } catch (m) {
                  d[u[o.selector]] = null;
                }
                r.off(u[o.selector]);
              ...
              r.off(".contextMenu .contextMenuAutoHide"),
                e.each(d, function (t, n) {
      ...
      (e.contextMenu.defaults = h),
      (e.contextMenu.types = p),
      (e.contextMenu.handle = g),
      (e.contextMenu.op = v),
      (e.contextMenu.menus = d);
  })(jQuery),
  (function (e, t, n, i) {
    var o = e(t);
  ...
  (function (e) {
    ...
    (n.scrollstart = {
      setup: function (o) {
        var r,
          s = e.extend({ latency: n.scrollstop.latency }, o),
          a = function (e) {
            var n = this,
              i = arguments;
            r ? clearTimeout(r) : ((e.type = "scrollstart"), t.apply(n, i)),
      ...
      (n.scrollstop = {
        ...
        setup: function (i) {
          var r,
            s = e.extend({ latency: n.scrollstop.latency }, i),
            a = function (e) {
              var n = this,
                i = arguments;
              r && clearTimeout(r),
  ...
  (function (e, t) {
    function n(e, t) {
      return (
        ...
        "string" == typeof p[t][e] ? p[t][e] : t != o ? n(e, o) : e
      );
    }
    var i = "en",
      o = "en",
    ...
    (d.setLocale = function (e) {
      ...
      (d.alert = function () {
        ...
        return d.dialog(
          e,
          { label: t, icon: u.OK, class: c.OK, callback: i },
          { onEscape: i || !0 }
        );
      }),
      (d.confirm = function () {
        ...
        return d.dialog(
          e,
          [
            { label: t, icon: u.CANCEL, class: c.CANCEL, callback: r },
            { label: i, icon: u.CONFIRM, class: c.CONFIRM, callback: s },
          ],
          { onEscape: r }
        );
      }),
        ...
        var p = function () {
          ...
          h = function () {
            return "function" == typeof r
              ? r(l.find("input[type=text]").val())
              : void 0;
          },
          f = d.dialog(
            l,
            [
              { label: i, icon: u.CANCEL, class: c.CANCEL, callback: p },
              { label: o, icon: u.CONFIRM, class: c.CONFIRM, callback: h },
            ],
      ...
      (d.dialog = function (n, i, o) {
        function c(e) {
          var t = null;
          "function" == typeof o.onEscape && (t = o.onEscape()),
            t !== !1 && k.modal("hide");
        }
        var u = "",
          d = [];
        ...
        for (var p = i.length; p--; ) {
          var h = null,
            ...
            v = null;
          if (
            "undefined" == typeof i[p].label &&
            "undefined" == typeof i[p]["class"] &&
            "undefined" == typeof i[p].callback
          ) {
            var y = 0,
              b = null;
            for (var w in i[p]) if (((b = w), ++y > 1)) break;
            1 == y &&
              "function" == typeof i[p][w] &&
              ((i[p].label = b), (i[p].callback = i[p][w]));
          }
          "function" == typeof i[p].callback && (v = i[p].callback),
            i[p]["class"]
              ? (m = i[p]["class"])
              : p == i.length - 1 && i.length <= 2 && (m = "btn-primary"),
            i[p].link !== !0 && (m = "btn " + m),
            (h = i[p].label ? i[p].label : "Option " + (p + 1)),
            i[p].icon && (g = "<i class='" + i[p].icon + "'></i> "),
            (f = i[p].href ? i[p].href : a),
            (u =
              "<a data-handler='" +
              p +
              "' class='" +
        ...
        if (o.header) {
          var C = "";
          ("undefined" == typeof o.headerCloseButton || o.headerCloseButton) &&
            (C = "<a href='" + a + "' class='close'>&times;</a>"),
            x.push(
        ...
        x.push("<div class='modal-body'></div>"),
          u && x.push("<div class='modal-footer'>" + u + "</div>"),
          x.push("</div>");
        var k = t(x.join("\n")),
        ...
        return (
          E && k.addClass(E),
          k.find(".modal-body").html(n),
          k.on("keyup.dismiss.modal", function (e) {
          ...
          k.on("click", ".modal-footer a", function (e) {
            var n = t(this).data("handler"),
              o = d[n],
              r = null;
            ("undefined" == typeof n || "undefined" == typeof i[n].href) &&
              (e.preventDefault(),
              "function" == typeof o && (r = o(e)),
              r !== !1 && k.modal("hide"));
          }),
          t("body").append(k),
          k.modal({
          ...
          ("undefined" == typeof o.show || o.show === !0) && k.modal("show"),
          k
        );
      }),
      (d.modal = function () {
        var e,
          n,
          i,
          o = { onEscape: null, keyboard: !0, backdrop: s };
        switch (arguments.length) {
          case 1:
            e = arguments[0];
            break;
        ...
        return (
          (o.header = n),
          (i = "object" == typeof i ? t.extend(o, i) : o),
          d.dialog(e, [], i)
        );
      }),
      (d.hideAll = function () {
    ...
    (s = function () {}),
      ...
      (e = (function (e) {
        function n(e, t) {
          ...
          if (
            ...
            (o = null != (s = n.optionsForElement(this.element)) ? s : {}),
            (this.options = i({}, this.defaultOptions, o, null != t ? t : {})),
            ...
            this.options.clickable &&
              (this.clickableElements =
                this.options.clickable === !0
                  ? [this.element]
                  : n.getElements(this.options.clickable, "clickable")),
            this.init();
        }
        var i, o;
        return (
            ...
            fallback: function () {
              ...
              for (
                this.element.className =
                  ...
                  s = this.element.getElementsByTagName("div"),
                  o = 0,
                  r = s.length;
                r > o;
                o++
              ...
              return (
                ...
                i && (i.textContent = this.options.dictFallbackMessage),
            ...
            resize: function (e) {
              ...
              return (
                ...
                null == t.optWidth && null == t.optHeight
                  ...
                  : null == t.optWidth
                  ? (t.optWidth = n * t.optHeight)
                  : null == t.optHeight && (t.optHeight = (1 / n) * t.optWidth),
                (i = t.optWidth / t.optHeight),
                e.height < t.optHeight || e.width < t.optWidth
                  ? ((t.trgHeight = t.srcHeight), (t.trgWidth = t.srcWidth))
                  : n > i
                  ? ((t.srcHeight = e.height), (t.srcWidth = t.srcHeight * i))
                  : ((t.srcWidth = e.width), (t.srcHeight = t.srcWidth / i)),
            ...
            addedfile: function (e) {
              ...
              if (
                ...
                for (
                  ...
                  (t = d[r]), (t.textContent = e.name);
                for (
                  p = e.previewElement.querySelectorAll("[data-dz-size]"),
                    s = 0,
                    c = p.length;
                  c > s;
                  s++
                )
                  (t = p[s]), (t.innerHTML = this.filesize(e.size));
                for (
                  ...
                  (o = h[a]), f.push(o.addEventListener("click", i));
                return f;
              }
            },
          ...
          (n.prototype.getFilesWithStatus = function (e) {
            var t, n, i, o, r;
            for (o = this.files, r = [], n = 0, i = o.length; i > n; n++)
              (t = o[n]), t.status === e && r.push(t);
            return r;
          }),
          ...
          (n.prototype.getActiveFiles = function () {
            var e, t, i, o, r;
            for (o = this.files, r = [], t = 0, i = o.length; i > t; t++)
              (e = o[t]),
                (e.status === n.UPLOADING || e.status === n.QUEUED) &&
                  r.push(e);
            return r;
          }),
          (n.prototype.init = function () {
            ...
            for (
                ...
                this.clickableElements.length &&
                  (i = (function (e) {
                    return function () {
                      return (
                        e.hiddenFileInput &&
                          document.body.removeChild(e.hiddenFileInput),
              ...
              (e = a[o]), this.on(e, this.options[e]);
            return (
              this.on(
                "uploadprogress",
                (function (e) {
              ...
              this.on(
                ...
                (function (e) {
                  return function (t) {
                    return 0 === e.getUploadingFiles().length &&
          ...
          (n.prototype.updateTotalUploadProgress = function () {
            ...
            if (((i = 0), (n = 0), (e = this.getActiveFiles()), e.length)) {
              for (a = this.getActiveFiles(), r = 0, s = a.length; s > r; r++)
                (t = a[r]), (i += t.upload.bytesSent), (n += t.upload.total);
              o = (100 * i) / n;
            } else o = 100;
          ...
          (n.prototype.getExistingFallback = function () {
            ...
            for (
              ...
              if (((n = r[i]), (e = t(this.element.getElementsByTagName(n)))))
                return e;
          }),
          (n.prototype.setupEventListeners = function () {
            var e, t, n, i, o, r, s;
            for (r = this.listeners, s = [], i = 0, o = r.length; o > i; i++)
              (e = r[i]),
                s.push(
                  (function () {
                    var i, o;
              ...
              (e = r[i]),
                s.push(
                  (function () {
                    ...
                    for (t in i)
                      (n = i[t]),
                        o.push(e.element.removeEventListener(t, n, !1));
                    return o;
                  })()
                );
            return s;
          ...
          (n.prototype.filesize = function (e) {
            ...
            for (
              ...
              if (
                ((r = s[n]),
                (t = Math.pow(this.options.filesizeBase, 4 - n) / 10),
                e >= t)
              ) {
            ...
            return (
              (i = Math.round(10 * i) / 10), "<strong>" + i + "</strong> " + o
            );
          }),
          ...
          (n.prototype.paste = function (e) {
            ...
            if (
              null !=
              (null != e && null != (n = e.clipboardData) ? n.items : void 0)
            )
              return (
                this.emit("paste", e),
          ...
          (n.prototype._addFilesFromItems = function (e) {
            var t, n, i, o, r;
            for (r = [], i = 0, o = e.length; o > i; i++)
              (n = e[i]),
                r.push(
                  null != n.webkitGetAsEntry && (t = n.webkitGetAsEntry())
                    ? t.isFile
                      ? this.addFile(n.getAsFile())
                      : t.isDirectory
                ...
                return function (n) {
                  ...
                  for (o = 0, r = n.length; r > o; o++)
                    (i = n[o]),
                      i.isFile
                        ? i.file(function (n) {
                            return e.options.ignoreHiddenFiles &&
                        ...
                        : i.isDirectory &&
                          e._addFilesFromDirectory(i, "" + t + "/" + i.name);
                };
              })(this)),
              n.readEntries(i, function (e) {
          ...
          (n.prototype.enqueueFile = function (e) {
            if (e.status !== n.ADDED || e.accepted !== !0)
              throw new Error(
          ...
          (n.prototype.removeAllFiles = function (e) {
            ...
            for (
              ...
              (t = r[i]), (t.status !== n.UPLOADING || e) && this.removeFile(t);
            return null;
          }),
          ...
          (n.prototype.processQueue = function () {
            ...
            if (
              ...
              (e = n),
              !(n >= t) && ((i = this.getQueuedFiles()), i.length > 0))
            ) {
          ...
          (n.prototype.cancelUpload = function (e) {
            ...
            if (e.status === n.UPLOADING) {
              for (
                i = this._getFilesWithXhr(e.xhr), o = 0, s = i.length;
                s > o;
                o++
              )
                (t = i[o]), (t.status = n.CANCELED);
              for (e.xhr.abort(), r = 0, a = i.length; a > r; r++)
                (t = i[r]), this.emit("canceled", t);
              this.options.uploadMultiple && this.emit("canceledmultiple", i);
            } else
              ((l = e.status) === n.ADDED || l === n.QUEUED) &&
                ((e.status = n.CANCELED),
          ...
          (n.prototype.uploadFiles = function (e) {
            var t,
              ...
              O,
              I;
            for (C = new XMLHttpRequest(), k = 0, N = e.length; N > k; k++)
              (t = e[k]), (t.xhr = C);
            (m = o(this.options.method, e)),
              (w = o(this.options.url, e)),
              C.open(m, w, !0),
                    ...
                    (t = e[i]),
                      r.push(
                        n._errorProcessing(
                          e,
                          y ||
                            n.options.dictResponseError.replace(
                              "{{statusCode}}",
                              C.status
                            ),
                          C
              ...
              (b = (function (n) {
                return function (i) {
                  ...
                  if (null != i)
                    for (
                      r = (100 * i.loaded) / i.total, s = 0, c = e.length;
                      c > s;
                      s++
                    )
                      (t = e[s]),
                    ...
                    for (o = !0, r = 100, a = 0, u = e.length; u > a; a++)
                      (t = e[a]),
                  ...
                  for (p = [], l = 0, d = e.length; d > l; l++)
                    (t = e[l]),
                      p.push(
                        n.emit("uploadprogress", t, r, t.upload.bytesSent)
                      );
                  return p;
                };
              })(this)),
                  ...
                  if (e[0].status !== n.CANCELED && 4 === C.readyState) {
                    if (
                      ...
                      C.getResponseHeader("content-type") &&
                        ~C.getResponseHeader("content-type").indexOf(
                          "application/json"
                        ))
                    )
                      try {
            ...
            for (T = 0, _ = e.length; _ > T; T++)
              (t = e[T]), this.emit("sending", t, C, r);
            if (
              (this.options.uploadMultiple &&
                this.emit("sendingmultiple", e, C, r),
              "FORM" === this.element.tagName)
            )
              for (
                P = this.element.querySelectorAll(
                ...
                if (
                  ...
                  for (F = d.options, $ = 0, D = F.length; D > $; $++)
                    (g = F[$]), g.selected && r.append(p, g.value);
                else
                  (!h ||
                    ("checkbox" !== (O = h.toLowerCase()) && "radio" !== O) ||
                    d.checked) &&
                    r.append(p, d.value);
            for (
              u = A = 0, I = e.length - 1;
      ...
      (e.discover = function () {
        ...
        for (
          ...
          (n = i[o]), s.push(e.optionsForElement(n) !== !1 ? new e(n) : void 0);
        return s;
      }),
      ...
      (e.isBrowserSupported = function () {
        ...
        if (
          ...
          if ("classList" in document.createElement("a"))
            for (r = e.blacklistedBrowsers, i = 0, o = r.length; o > i; i++)
              (n = r[i]), n.test(navigator.userAgent) && (t = !1);
          else t = !1;
        else t = !1;
        return t;
      }),
        ...
        if (e instanceof Array) {
          ...
          try {
            for (r = 0, a = e.length; a > r; r++)
              (i = e[r]), o.push(this.getElement(i, t));
          } catch (u) {
            (n = u), (o = null);
          }
        } else if ("string" == typeof e)
          for (
            o = [], c = document.querySelectorAll(e), s = 0, l = c.length;
            l > s;
            s++
          )
            (i = c[s]), o.push(i);
      ...
      (i = function (e, t) {
        ...
        if (
          ...
          (r = function (n) {
            return "readystatechange" !== n.type || "complete" === i.readyState
              ? (("load" === n.type ? e : i)[l](a + n.type, r, !1),
                !o && (o = !0) ? t.call(e, n.type || n) : void 0)
              : void 0;
          }),
          (s = function () {
            var e;
          ...
          return (
            i[n](a + "DOMContentLoaded", r, !1),
            i[n](a + "readystatechange", r, !1),
            e[n](a + "load", r, !1)
          );
        }
      }),
    ...
    function n(t, n) {
      function _(t) {
        if (!(ce() || e(t.target).closest(n.excludedElements, qe).length > 0)) {
          ...
          return (
            (Ue = w),
            T ? (Xe = o.touches.length) : t.preventDefault(),
            (Fe = 0),
            (Oe = null),
            (Re = null),
            (Ie = 0),
            ...
            (Be = ve()),
            ae(),
            !T || Xe === n.fingers || n.fingers === y || B()
              ? (de(0, r),
                (Qe = $e()),
                2 == Xe &&
                  (de(1, o.touches[1]),
                  (He = je = we(Ye[0].start, Ye[1].start))),
                (n.swipeStatus || n.pinchStatus) && (i = F(o, Ue)))
              : (i = !1),
            i === !1
              ? ((Ue = k), F(o, Ue), i)
              : (n.hold &&
                  (et = setTimeout(
                    e.proxy(function () {
                      qe.trigger("hold", [o.target]),
                        n.hold && (i = n.hold.call(qe, o, o.target));
                    }, this),
                    n.longTapThreshold
                  )),
                ue(!0),
            ...
            2 == Xe &&
              (0 == He
                ? (de(1, t.touches[1]),
                  (He = je = we(Ye[0].start, Ye[1].start)))
                : (pe(t.touches[1]),
                  (je = we(Ye[0].end, Ye[1].end)),
                  (Re = Ce(Ye[0].end, Ye[1].end))),
              (ze = xe(He, je)),
              (We = Math.abs(He - je))),
            Xe === n.fingers || n.fingers === y || !T || B())
          ) {
            if (
              ((Oe = Ee(r.start, r.end)),
              W(e, Oe),
              ...
              (Ie = be()),
              me(Oe, Fe),
              (n.swipeStatus || n.pinchStatus) && (i = F(t, Ue)),
              ...
              !n.triggerOnTouchEnd && s
                ? (Ue = P(x))
                : n.triggerOnTouchLeave && !s && (Ue = P(C)),
                (Ue == k || Ue == C) && F(t, Ue);
            }
          } else (Ue = k), F(t, Ue);
          i === !1 && ((Ue = k), F(t, Ue));
      ...
      function D(e) {
        ...
        return T && t.touches.length > 0
          ...
          : (le() && (Xe = Ve),
            ...
            H() || !I()
              ? ((Ue = k), F(t, Ue))
              : n.triggerOnTouchEnd || (0 == n.triggerOnTouchEnd && Ue === x)
              ? (e.preventDefault(), (Ue = C), F(t, Ue))
      ...
      function P(e) {
        ...
        return (
          !i || r
            ? (t = k)
            : !o || e != x || (n.triggerOnTouchEnd && !n.triggerOnTouchLeave)
            ? !o && e == C && n.triggerOnTouchLeave && (t = k)
            : (t = C),
          t
        );
      }
      function F(e, t) {
        ...
        return (
          Y() || X() || q() || B()
            ...
            : ie() && n !== !1 && (n = O(e, t, h)),
          t === k && A(e),
          t === C && (T ? 0 == e.touches.length && A(e) : A(e)),
          n
        );
      }
      function O(t, c, u) {
        ...
        if (u == d) {
          ...
          if (c == C && U()) {
            if (
              (qe.trigger("swipe", [Oe, Fe, Ie, Xe, Ye]),
              n.swipe &&
                ((g = n.swipe.call(qe, t, Oe, Fe, Ie, Xe, Ye)), g === !1))
            )
              return !1;
            switch (Oe) {
              case i:
                qe.trigger("swipeLeft", [Oe, Fe, Ie, Xe, Ye]),
                  n.swipeLeft &&
                    (g = n.swipeLeft.call(qe, t, Oe, Fe, Ie, Xe, Ye));
                break;
              case o:
                qe.trigger("swipeRight", [Oe, Fe, Ie, Xe, Ye]),
                  n.swipeRight &&
                    (g = n.swipeRight.call(qe, t, Oe, Fe, Ie, Xe, Ye));
                break;
              case r:
                qe.trigger("swipeUp", [Oe, Fe, Ie, Xe, Ye]),
                  n.swipeUp && (g = n.swipeUp.call(qe, t, Oe, Fe, Ie, Xe, Ye));
                break;
              case s:
                qe.trigger("swipeDown", [Oe, Fe, Ie, Xe, Ye]),
                  n.swipeDown &&
                    (g = n.swipeDown.call(qe, t, Oe, Fe, Ie, Xe, Ye));
            }
          }
        }
        if (u == p) {
          if (
            (qe.trigger("pinchStatus", [
              c,
              Re || null,
              We || 0,
              Ie || 0,
        ...
        return (
          u == h
              ...
              V() && !ee()
                ? ((Je = $e()),
                  (Ze = setTimeout(
                    e.proxy(function () {
                      (Je = null),
                        qe.trigger("tap", [t.target]),
                        n.tap && (g = n.tap.call(qe, t, t.target));
                    }, this),
            ...
            ? (c === k || c === C) &&
              (clearTimeout(Ze),
              (Je = null),
              qe.trigger("doubletap", [t.target]),
              n.doubleTap && (g = n.doubleTap.call(qe, t, t.target)))
            : u == m &&
              (c === k || c === C) &&
              (clearTimeout(Ze),
              (Je = null),
              qe.trigger("longtap", [t.target]),
              n.longTap && (g = n.longTap.call(qe, t, t.target))),
          g
        );
      }
      function I() {
      ...
      function ue(e) {
        e === !0
          ? (qe.bind(Ae, S), qe.bind(Me, D), Le && qe.bind(Le, M))
          : (qe.unbind(Ae, S, !1),
            qe.unbind(Me, D, !1),
            Le && qe.unbind(Le, M, !1)),
          qe.data(N + "_intouch", e === !0);
      }
      function de(e, t) {
        var n = void 0 !== t.identifier ? t.identifier : 0;
        return (
          (Ye[e].identifier = n),
          (Ye[e].start.x = Ye[e].end.x = t.pageX || t.clientX),
          (Ye[e].start.y = Ye[e].end.y = t.pageY || t.clientY),
          Ye[e]
        );
      }
      function pe(e) {
        var t = void 0 !== e.identifier ? e.identifier : 0,
          n = he(t);
        return (
          (n.end.x = e.pageX || e.clientX), (n.end.y = e.pageY || e.clientY), n
        );
      }
      function he(e) {
      ...
      function fe() {
        for (var e = [], t = 0; 5 >= t; t++)
          e.push({ start: { x: 0, y: 0 }, end: { x: 0, y: 0 }, identifier: 0 });
        return e;
      }
      function me(e, t) {
      ...
      function ve() {
        var e = {};
        return (
          (e[i] = ye(i)), (e[o] = ye(o)), (e[r] = ye(r)), (e[s] = ye(s)), e
        );
      }
      function ye(e) {
  ...
  !(function (e) {
    ...
    n.prototype = {
          ...
          e(window).on("resize.modal", function () {
            i && clearTimeout(i),
              (i = setTimeout(function () {
                for (var e = 0; e < o.stack.length; e++)
                  o.stack[e].isShown && o.stack[e].layout();
              }, 10));
          });
        }
      },
        ...
        n.$element.on(
          ...
          t(function (t) {
            var o = function () {
              ...
              i.$element
                .toggleClass("modal-open", i.hasOpenModal())
                .toggleClass(
                  "page-overflow",
                  e(window).height() < i.$element.height()
                ),
                (n.$parent = n.$element.parent()),
                (n.$container = i.createContainer(n)),
                n.$element.appendTo(n.$container),
              ...
              if ((i.backdrop(n), n.$element.parent().length))
                if (n.$backdrop) {
                  ...
                  o && n.$element[0].offsetWidth,
                    e.support.transition && n.$element.hasClass("fade")
                      ? n.$backdrop.one(e.support.transition.end, function () {
                          n.destroy();
                        })
                      : n.destroy();
                } else n.destroy();
      ...
      getOpenModals: function () {
        for (var e = [], t = 0; t < this.stack.length; t++)
          this.stack[t].isShown && e.push(this.stack[t]);
        return e;
      },
      ...
      setFocus: function () {
        for (var e, t = 0; t < this.stack.length; t++)
          this.stack[t].isShown && (e = this.stack[t]);
        e && e.focus();
      },
      destroyModal: function (e) {
        e.$element.off(".modalmanager"),
          e.$backdrop && this.removeBackdrop(e),
      ...
      replace: function (n) {
        for (var i, o = 0; o < this.stack.length; o++)
          this.stack[o].isShown && (i = this.stack[o]);
        i
          ? ((this.$backdropHandle = i.$backdrop),
            (i.$backdrop = null),
            n && i.$element.one("hidden", t(e.proxy(n, this))),
            i.hide())
          : n && n();
      },
      ...
      createBackdrop: function (t, n) {
        ...
        return (
          this.$backdropHandle
            ? ((i = this.$backdropHandle),
              i.off(".modalmanager"),
              (this.$backdropHandle = null),
              this.isLoading && this.removeSpinner())
            : (i = e(n).addClass(t).appendTo(this.$element)),
          i
        );
      },
      ...
      createContainer: function (n) {
        var o;
        return (
          (o = e('<div class="modal-scrollable">')
            .css("z-index", i("modal", this.getOpenModals().length))
            .appendTo(this.$element)),
          n && "static" != n.options.backdrop
            ? o.on(
                "click.modal",
                t(function (e) {
                  n.hide();
      ...
      backdrop: function (t, n) {
        ...
        if (t.isShown && r) {
          ...
          (t.$backdrop = this.createBackdrop(o, t.options.backdropTemplate)),
            t.$backdrop.css(
              "z-index",
              i("backdrop", this.getOpenModals().length)
            ),
            s && t.$backdrop[0].offsetWidth,
            t.$backdrop.addClass("in"),
            (this.backdropCount += 1),
            s ? t.$backdrop.one(e.support.transition.end, n) : n();
        } else if (!t.isShown && t.$backdrop) {
          t.$backdrop.removeClass("in"), (this.backdropCount -= 1);
          var a = this;
          e.support.transition && t.$element.hasClass("fade")
            ? t.$backdrop.one(e.support.transition.end, function () {
                a.removeBackdrop(t);
              })
            : a.removeBackdrop(t);
        } else n && n();
      ...
      loading: function (t) {
        if (
          ...
          this.$element
            ...
            .toggleClass(
              "page-overflow",
              e(window).height() < this.$element.height()
            ),
          this.isLoading)
        )
          if (this.isLoading && this.$backdropHandle) {
            ...
            e.support.transition
              ? this.$backdropHandle.one(e.support.transition.end, function () {
                  n.removeLoading();
                })
              : n.removeLoading();
          ...
          this.$backdropHandle
            .css("z-index", i("backdrop", o.length + 1))
            .addClass("in");
          var r = e(this.options.spinner)
            .css("z-index", i("modal", o.length + 1))
            .appendTo(this.$element)
            .addClass("in");
          (this.$spinner = e(this.createContainer())
            .append(r)
            .on("click.modalmanager", e.proxy(this.loading, this))),
            (this.isLoading = !0),
            e.support.transition
              ? this.$backdropHandle.one(e.support.transition.end, t)
              : t();
        }
      },
    };
    var i = (function () {
      ...
      return function (i, o) {
        if ("undefined" == typeof t) {
          ...
          (n.modal = +r.css("z-index")),
            (n.backdrop = +s.css("z-index")),
            (t = n.modal - n.backdrop),
            r.remove(),
            s.remove(),
            (s = r = null);
        }
    ...
    (e.fn.modalmanager = function (t, i) {
      return this.each(function () {
        ...
        r || o.data("modalmanager", (r = new n(this, t))),
          "string" == typeof t && r[t].apply(r, [].concat(i));
      });
    }),
      (e.fn.modalmanager.defaults = {
        backdropLimit: 999,
      ...
      (e.fn.modalmanager.Constructor = n),
      e(function () {
  ...
  !(function (e) {
    ...
    (t.prototype = {
      ...
      init: function (t, n) {
        ...
        var o =
          "function" == typeof this.options.manager
            ? this.options.manager.call(this)
            : this.options.manager;
        (o = o.appendModal ? o : e(o).modalmanager().data("modalmanager")),
          o.appendModal(this);
      },
      toggle: function () {
        return this[this.isShown ? "hide" : "show"]();
      ...
      layout: function () {
        ...
        if (this.options.width) {
          ...
          this.$element.css("margin-left", function () {
            return /%/gi.test(i.options.width)
              ? -(parseInt(i.options.width) / 2) + "%"
              : -(e(this).width() / 2) + "px";
          });
        } else
      ...
      tab: function () {
        var t = this;
        this.isShown && this.options.consumeTab
          ? this.$element.on(
              ...
              function (n) {
                if (n.keyCode && 9 == n.keyCode) {
                  var i = e(this),
                    o = e(this);
                  t.$element
                    .find("[data-tabindex]:enabled:not([readonly])")
                    .each(function (t) {
                      i = t.shiftKey
                        ? i.data("tabindex") > e(this).data("tabindex")
                          ? (i = e(this))
                          : (o = e(this))
                        : i.data("tabindex") < e(this).data("tabindex")
                        ? (i = e(this))
      ...
      hideModal: function () {
        ...
        t && this.$element.find(".modal-body").css("overflow", "").css(e, ""),
      ...
      loading: function (t) {
        ...
        if (this.isLoading)
          if (this.isLoading && this.$loading) {
            ...
            var i = this;
            e.support.transition && this.$element.hasClass("fade")
              ? this.$loading.one(e.support.transition.end, function () {
                  i.removeLoading();
                })
              : i.removeLoading();
          } else t && t(this.isLoading);
          ...
          (this.$loading = e('<div class="loading-mask ' + n + '">')
            .append(this.options.spinner)
            .appendTo(this.$element)),
            o && this.$loading[0].offsetWidth,
            this.$loading.addClass("in"),
            (this.isLoading = !0),
            o ? this.$loading.one(e.support.transition.end, t) : t();
        }
      },
      focus: function () {
      ...
      attention: function () {
        if (this.options.attentionAnimation) {
          ...
          setTimeout(function () {
            e.$element
              .addClass("animated")
              .addClass(e.options.attentionAnimation);
          }, 0);
        }
        this.focus();
      },
      ...
      (e.fn.modal = function (n, i) {
        return this.each(function () {
          ...
          r || o.data("modal", (r = new t(this, s))),
            "string" == typeof n
              ? r[n].apply(r, [].concat(i))
              : s.show && r.show();
        });
      }),
      (e.fn.modal.defaults = {
  ...
  (function (e, t) {
    ...
    var n,
      ...
      N = function (e, t) {
        if (
          ...
          ((1 === t.nodeType &&
            ...
            (9 === t.nodeType && !t.ownerDocument && t === e.ownerDocument))
        )
          do {
            if (e === t) return !0;
            e = e.parentNode;
      ...
      A = function () {
        ...
        if (((n = r.getElementsByTagName("script")), 1 === n.length))
          return n[0].src || t;
        if ("readyState" in n[0])
          for (i = n.length; i--; )
            if ("interactive" === n[i].readyState && (e = n[i].src)) return e;
        return "loading" === r.readyState && (e = n[n.length - 1].src)
          ? e
          : (e = D())
          ? e
          : t;
      ...
      R = function () {
        return {
          ...
          flash: E(P, ["bridge"]),
          zeroclipboard: { version: Ae.version, config: Ae.config() },
        };
      },
      B = function () {
        ...
        if (o && o.length) {
          ...
          if ((r.ready && P.ready && Ae.emit({ type: "ready" }), r.error)) {
            ...
            for (n = 0, i = s.length; i > n; n++)
              if (P[s[n]] === !0) {
                Ae.emit({ type: "error", name: "flash-" + s[n] });
                break;
              }
          }
        }
      ...
      U = function (e, t) {
        ...
        if (r && r.length)
          for (n = 0, i = r.length; i > n; n++)
            if (
              ((e = r[n].toLowerCase().replace(/^on/, "")),
              (s = O[e]),
              s && s.length)
            )
              if (t)
                for (o = s.indexOf(t); -1 !== o; )
                  s.splice(o, 1), (o = s.indexOf(t, o));
              else s.length = 0;
        return Ae;
      },
      X = function (e) {
      ...
      Y = function (e) {
        ...
        return (
          (e = ie(e)),
          e && !ce(e)
            ? "ready" === e.type && P.overdue === !0
              ? Ae.emit({ type: "error", name: "flash-overdue" })
              : ((t = C({}, e)),
                le.call(this, t),
                "copy" === e.type &&
                  ((i = me(I)), (n = i.data), (H = i.formatMap)),
                n)
            : void 0
        );
      },
      Q = function () {
        if (
          ("boolean" != typeof P.ready && (P.ready = !1),
          !Ae.isFlashUnusable() && null === P.bridge)
        ) {
          ...
          "number" == typeof e &&
            ...
            a(function () {
              "boolean" != typeof P.deactivated && (P.deactivated = !0),
                P.deactivated === !0 &&
                  Ae.emit({ type: "error", name: "flash-deactivated" });
            }, e),
            (P.overdue = !1),
            he();
        }
      ...
      V = function (e) {
        "undefined" == typeof e
          ? ($(I), (H = null))
          : "string" == typeof e && y.call(I, e) && delete I[e];
      },
      J = function (e) {
        return "undefined" == typeof e
          ? k(I)
          : "string" == typeof e && y.call(I, e)
          ? I[e]
          : void 0;
      },
      Z = function (e) {
        if (e && 1 === e.nodeType) {
          n && (ke(n, z.activeClass), n !== e && ke(n, z.hoverClass)),
            (n = e),
            Ce(e, z.hoverClass);
      ...
      ee = function () {
        ...
        e &&
          ...
          (e.style.width = "1px"),
          (e.style.top = "1px")),
          n && (ke(n, z.hoverClass), ke(n, z.activeClass), (n = null));
      },
      te = function () {
        return n || null;
      },
      ne = function (e) {
        return (
          "string" == typeof e && e && /^[A-Za-z][A-Za-z0-9_:\-\.]*$/.test(e)
        );
      },
      ie = function (e) {
        var t;
        if (
          ...
          !e.target &&
            /^(copy|aftercopy|_click)$/.test(t.toLowerCase()) &&
            (e.target = i),
            C(e, {
              type: t.toLowerCase(),
          ...
          var o = j[e.type];
          return (
            "error" === e.type && e.name && o && (o = o[e.name]),
            o && (e.message = o),
            "ready" === e.type && C(e, { target: null, version: P.version }),
            "error" === e.type &&
              (/^flash-(disabled|outdated|unavailable|deactivated|overdue)$/.test(
                e.name
              ) && C(e, { target: null, minimumVersion: F }),
              /^flash-(outdated|unavailable|deactivated|overdue)$/.test(
                e.name
              ) && C(e, { version: P.version })),
            "copy" === e.type &&
              (e.clipboardData = {
                setData: Ae.setData,
                clearData: Ae.clearData,
              }),
            "aftercopy" === e.type && (e = ge(e, H)),
            e.target && !e.relatedTarget && (e.relatedTarget = oe(e.target)),
            (e = re(e))
          );
        }
      },
      ...
      re = function (e) {
        if (e && /^_(?:click|mouse(?:over|out|down|up|move))$/.test(e.type)) {
          var n = e.target,
            i =
              "_mouseover" === e.type && e.relatedTarget ? e.relatedTarget : t,
        ...
        if ("object" == typeof e && e && e.type) {
          ...
          if (r && r.length) {
            ...
            for (s = 0, a = r.length; a > s; s++)
              (l = r[s]),
                (c = d),
                "string" == typeof l && "function" == typeof o[l] && (l = o[l]),
                "object" == typeof l &&
                  l &&
                  "function" == typeof l.handleEvent &&
                  ((c = l), (l = l.handleEvent)),
                "function" == typeof l && ((u = C({}, e)), ae(l, c, [u], t));
          }
          return this;
        }
      },
      ce = function (e) {
        ...
        switch (e.type) {
          ...
          case "copy":
            ...
            !I["text/plain"] &&
            c &&
            (l = c.value || c.outerHTML || c.innerHTML) &&
            (a = c.value || c.textContent || c.innerText)
              ? (e.clipboardData.clearData(),
                e.clipboardData.setData("text/plain", a),
                l !== a && e.clipboardData.setData("text/html", l))
              : !I["text/plain"] &&
                e.target &&
                (a = e.target.getAttribute("data-clipboard-text")) &&
                (e.clipboardData.clearData(),
                e.clipboardData.setData("text/plain", a));
            break;
          case "aftercopy":
          ...
          case "_mouseout":
            Ae.blur(),
              z.bubbleEvents === !0 &&
                ...
                ue(C({}, e, { type: "mouseout" })));
            break;
          case "_mousedown":
            Ce(t, z.activeClass),
              z.bubbleEvents === !0 &&
                o &&
                ue(C({}, e, { type: e.type.slice(1) }));
            break;
          case "_mouseup":
            ke(t, z.activeClass),
              z.bubbleEvents === !0 &&
        ...
        return /^_(?:click|mouse(?:over|out|down|up|move))$/.test(e.type)
          ? !0
          : void 0;
      },
      ue = function (e) {
        if (e && "string" == typeof e.type && e) {
          ...
          n &&
            ...
            (t = i.createEvent("MouseEvents")),
            t.initMouseEvent &&
              (t.initMouseEvent.apply(t, a),
              (t._source = "js"),
              n.dispatchEvent(t)));
        }
      },
      de = function () {
        ...
        return (
          (e.id = z.containerId),
          (e.className = z.containerClass),
          (e.style.position = "absolute"),
          (e.style.left = "0px"),
          (e.style.top = "-9999px"),
          (e.style.width = "1px"),
          (e.style.height = "1px"),
          (e.style.zIndex = "" + Se(z.zIndex)),
          e
        );
      },
      pe = function (e) {
        for (
          ...
          t && "OBJECT" === t.nodeName && t.parentNode;
        ...
        if (!t) {
          ...
          (u.innerHTML =
            ...
            (d
              ...
              : 'type="application/x-shockwave-flash" data="' + l + '"') +
            ">" +
            (d ? '<param name="movie" value="' + l + '"/>' : "") +
      ...
      fe = function () {
        ...
        if (e) {
          var t = pe(e);
          t &&
            ("activex" === P.pluginType && "readyState" in e
      ...
      me = function (e) {
        ...
        if ("object" == typeof e && e) {
          for (var i in e)
            if (i && y.call(e, i) && "string" == typeof e[i] && e[i])
      ...
      ge = function (e, t) {
        ...
        for (var i in e)
          if (y.call(e, i)) {
            ...
            var o = e[i];
            for (var r in o)
              r && y.call(o, r) && y.call(t, r) && (n[i][t[r]] = o[r]);
          }
        return n;
      },
      ve = function (e, t) {
      ...
      ye = function (e) {
        ...
        if (
          (e.trustedDomains &&
            ("string" == typeof e.trustedDomains
              ? (r = [e.trustedDomains])
              : "object" == typeof e.trustedDomains &&
                "length" in e.trustedDomains &&
                (r = e.trustedDomains)),
          r && r.length)
        )
        ...
        return (
          a.length && (s += "trustedOrigins=" + l(a.join(","))),
          e.forceEnhancedClipboard === !0 &&
            (s += (s ? "&" : "") + "forceEnhancedClipboard=true"),
      ...
      be = function (e) {
        ...
        var n = e.indexOf("/");
        return (
          (e = -1 === n ? e : -1 === t || 0 === n ? null : e.slice(0, n)),
      ...
      we = (function () {
        ...
        return function (t, n) {
          ...
          if (r > 0) {
            ...
            if (-1 !== o.indexOf(t))
              return 1 === r && t === i ? "sameDomain" : "always";
          }
          return "never";
        };
      })(),
      ...
      Te = function (e, t) {
        ...
        return "cursor" !== t || (n && "auto" !== n) || "A" !== e.nodeName
          ? n
          : "pointer";
      },
      Ee = function () {
        var e,
          ...
          i = 1;
        return (
          "function" == typeof r.body.getBoundingClientRect &&
            ((e = r.body.getBoundingClientRect()),
            (t = e.right - e.left),
            (n = r.body.offsetWidth),
            (i = f((t / n) * 100) / 100)),
          i
        );
      },
      $e = function (e) {
        ...
        if (e.getBoundingClientRect) {
          ...
          "pageXOffset" in o && "pageYOffset" in o
            ? ((n = o.pageXOffset), (i = o.pageYOffset))
            : ((s = Ee()),
              (n = f(r.documentElement.scrollLeft / s)),
              (i = f(r.documentElement.scrollTop / s)));
      ...
      _e = function (e) {
        P.ready === !0 &&
          (P.bridge && "function" == typeof P.bridge.setHandCursor
            ? P.bridge.setHandCursor(e)
            : (P.ready = !1));
      },
      Se = function (e) {
      ...
      De = function (e) {
        ...
        if (s.plugins && s.plugins.length)
          (o = s.plugins["Shockwave Flash"]),
            i(o),
            s.plugins["Shockwave Flash 2.0"] && ((l = !0), (d = "2.0.0.11"));
        else if (s.mimeTypes && s.mimeTypes.length)
          (a = s.mimeTypes["application/x-shockwave-flash"]),
            (o = a && a.enabledPlugin),
            i(o);
        else if ("undefined" != typeof e) {
          c = !0;
          try {
            (r = new e("ShockwaveFlash.ShockwaveFlash.7")),
              (l = !0),
              (d = t(r.GetVariable("$version")));
          } catch (h) {
            try {
              (r = new e("ShockwaveFlash.ShockwaveFlash.6")),
                (l = !0),
                (d = "6.0.21");
            } catch (f) {
              try {
                (r = new e("ShockwaveFlash.ShockwaveFlash")),
                  (l = !0),
                  (d = t(r.GetVariable("$version")));
              } catch (m) {
                c = !1;
    ...
    var Ae = function () {
      return this instanceof Ae
        ? void (
            "function" == typeof Ae._createClient &&
            Ae._createClient.apply(this, x(arguments))
          )
        : new Ae();
    };
    v(Ae, "version", {
      ...
      (Ae.focus = Ae.activate =
        function () {
          return Z.apply(this, x(arguments));
        }),
      (Ae.blur = Ae.deactivate =
        function () {
    ...
    var Ie = function (e) {
        var t = this;
        (t.id = "" + Me++),
          (Le[t.id] = { instance: t, elements: [], handlers: {} }),
          e && t.clip(e),
          Ae.on("*", function (e) {
            return t.emit(e);
          }),
        ...
        if (o && o.length) {
          for (n = 0, i = o.length; i > n; n++)
            (e = o[n].replace(/^on/, "")),
              ...
              s[e].push(t);
          if (
            (r.ready && P.ready && this.emit({ type: "ready", client: this }),
            r.error)
          ) {
            var a = [
              "disabled",
      ...
      je = function (e, t) {
        var n,
          ...
          r,
          s,
          a = Le[this.id] && Le[this.id].handlers;
      ...
      ze = function (e) {
        ...
        return (
          n &&
            (t =
              "string" == typeof e && e ? (n[e] ? n[e].slice(0) : []) : k(n)),
          t
        );
      },
      We = function (e) {
      ...
      Re = function (e) {
        ...
        for (var t = 0; t < e.length; t++)
          if (y.call(e, t) && e[t] && 1 === e[t].nodeType) {
            e[t].zcClippingId
              ? -1 === Fe[e[t].zcClippingId].indexOf(this.id) &&
                Fe[e[t].zcClippingId].push(this.id)
              : ((e[t].zcClippingId = "zcClippingId_" + Pe++),
                (Fe[e[t].zcClippingId] = [this.id]),
                z.autoActivate === !0 && Ke(e[t]));
            var n = Le[this.id] && Le[this.id].elements;
        ...
        for (var o = e.length; o--; )
          if (y.call(e, o) && e[o] && 1 === e[o].nodeType) {
            ...
            if (r) {
              ...
              0 === r.length &&
                (z.autoActivate === !0 && Ge(e[o]), delete e[o].zcClippingId);
            }
          }
        return this;
      },
        ...
        if (e && 1 === e.nodeType) {
          ...
          if ("object" == typeof t && t) {
            for (
              ...
              (n = "mouse" + o[r]),
                (i = t[n]),
                "function" == typeof i && e.removeEventListener(n, i, !1);
  ...
  (function (e, t) {
    function n(t, n) {
      ...
      return "area" === a
        ? ((o = t.parentNode),
          (r = o.name),
          t.href && r && "map" === o.nodeName.toLowerCase()
            ? ((s = e("img[usemap=#" + r + "]")[0]), !!s && i(s))
            : !1)
  ...
  (function (e, t) {
    function n(e, t, n) {
      return [
        ...
        parseFloat(e[1]) * (h.test(e[1]) ? n / 100 : 1),
      ];
    }
    function i(t, n) {
      ...
      (e.fn.position = function (t) {
        ...
        return (
          ...
          this.each(function () {
            ...
            "right" === t.my[0]
              ? ($.left -= d)
              : "center" === t.my[0] && ($.left -= d / 2),
              "bottom" === t.my[1]
                ? ($.top -= p)
                : "center" === t.my[1] && ($.top -= p / 2),
              ($.left += N[0]),
              ($.top += N[1]),
              e.support.offsetFractions ||
                (($.left = l($.left)), ($.top = l($.top))),
              (o = { marginLeft: f, marginTop: y }),
              ...
              t.using &&
                (c = function (e) {
                  ...
                  d > h && a(n + i) < h && (l.horizontal = "center"),
                    p > m && a(o + r) < m && (l.vertical = "middle"),
                    (l.important =
                      s(a(n), a(i)) > s(a(o), a(r))
                        ? "horizontal"
                        : "vertical"),
      ...
      (e.ui.position = {
        fit: {
          left: function (e, t) {
            ...
            t.collisionWidth > r
              ? l > 0 && 0 >= c
                ? ((n = e.left + l + t.collisionWidth - r - o),
                  (e.left += l - n))
                : (e.left =
                    c > 0 && 0 >= l ? o : l > c ? o + r - t.collisionWidth : o)
              : l > 0
              ? (e.left += l)
              : c > 0
              ? (e.left -= c)
          ...
          top: function (e, t) {
            ...
            t.collisionHeight > r
              ? l > 0 && 0 >= c
                ? ((n = e.top + l + t.collisionHeight - r - o),
                  (e.top += l - n))
                : (e.top =
                    c > 0 && 0 >= l ? o : l > c ? o + r - t.collisionHeight : o)
              : l > 0
              ? (e.top += l)
              : c > 0
              ? (e.top -= c)
        ...
        flip: {
          left: function (e, t) {
            var n,
              ...
              f = -2 * t.offset[0];
            0 > u
              ? ((n = e.left + p + h + f + t.collisionWidth - s - r),
                (0 > n || n < a(u)) && (e.left += p + h + f))
              : d > 0 &&
                ((i = e.left - t.collisionPosition.marginLeft + p + h + f - l),
                (i > 0 || a(i) < d) && (e.left += p + h + f));
          },
          top: function (e, t) {
            var n,
              i,
              ...
              m = -2 * t.offset[1];
            0 > u
              ? ((i = e.top + h + f + m + t.collisionHeight - s - r),
                e.top + h + f + m > u &&
                  (0 > i || i < a(u)) &&
                  (e.top += h + f + m))
              : d > 0 &&
  ...
  (function (e, t) {
    ...
    (e.cleanData = function (t) {
      ...
      (e.widget = function (t, n, i) {
        ...
        (t = t.split(".")[1]),
          ...
          (s.prototype = e.widget.extend(
            ...
            l,
            { constructor: s, namespace: c, widgetName: t, widgetFullName: o }
          )),
          r
      ...
      (e.widget.extend = function (n) {
        for (
          var o, r, s = i.call(arguments, 1), a = 0, l = s.length;
          l > a;
          a++
        )
          for (o in s[a])
            (r = s[a][o]),
              s[a].hasOwnProperty(o) &&
                r !== t &&
                (n[o] = e.isPlainObject(r)
                  ? e.isPlainObject(n[o])
                    ? e.widget.extend({}, n[o], r)
                    : e.widget.extend({}, r)
                  : r);
        return n;
      }),
      (e.widget.bridge = function (n, o) {
        ...
        e.fn[n] = function (s) {
          ...
          return (
            (s =
              !a && l.length ? e.widget.extend.apply(null, [s].concat(l)) : s),
            this.each(
              a
                ? function () {
                    var i,
      ...
      (e.Widget.prototype = {
        ...
        option: function (n, i) {
          ...
          if ("string" == typeof n)
            if (((a = {}), (o = n.split(".")), (n = o.shift()), o.length)) {
              for (
                r = a[n] = e.widget.extend({}, this.options[n]), s = 0;
                s < o.length - 1;
                s++
              )
                (r[o[s]] = r[o[s]] || {}), (r = r[o[s]]);
              if (((n = o.pop()), 1 === arguments.length))
                return r[n] === t ? null : r[n];
              r[n] = i;
            } else {
        ...
        _trigger: function (t, n, i) {
          ...
          return (
            ...
            !(
              (e.isFunction(s) &&
                s.apply(this.element[0], [n].concat(i)) === !1) ||
              n.isDefaultPrevented()
            )
          );
        },
      ...
      e.each({ show: "fadeIn", hide: "fadeOut" }, function (t, n) {
        e.Widget.prototype["_" + t] = function (i, o, r) {
          ...
          var s,
            a = o ? (o === !0 || "number" == typeof o ? n : o.effect || n) : t;
          (o = o || {}),
            ...
            var i = this,
              ...
              r =
                "string" == typeof this.options.cancel && t.target.nodeName
                  ...
                  : !1;
            return o && !r && this._mouseCapture(t)
    ...
    e.widget("ui.draggable", e.ui.mouse, {
      ...
      e.ui.plugin.add("draggable", "snap", {
        ...
        drag: function (t, n) {
          ...
          for (d = h.snapElements.length - 1; d >= 0; d--)
            (a = h.snapElements[d].left),
              (l = a + h.snapElements[d].width),
              (c = h.snapElements[d].top),
              (u = c + h.snapElements[d].height),
              a - m > v ||
              g > l + m ||
              c - m > b ||
              y > u + m ||
              !e.contains(
                h.snapElements[d].item.ownerDocument,
                h.snapElements[d].item
              )
                ? (h.snapElements[d].snapping &&
                ...
                : ("inner" !== f.snapMode &&
                    ...
                    o &&
                      (n.position.top =
                        h._convertPositionTo("relative", { top: u, left: 0 })
                          .top - h.margins.top),
                    r &&
                      (n.position.left =
                        h._convertPositionTo("relative", {
                  ...
                  "outer" !== f.snapMode &&
                    ...
                    i &&
                      (n.position.top =
                        h._convertPositionTo("relative", { top: c, left: 0 })
                          .top - h.margins.top),
                    o &&
                      (n.position.top =
                        h._convertPositionTo("relative", {
                    ...
                    r &&
                      (n.position.left =
                        h._convertPositionTo("relative", { top: 0, left: a })
                          .left - h.margins.left),
                    s &&
                      (n.position.left =
                        h._convertPositionTo("relative", {
      ...
      e.ui.plugin.add("draggable", "stack", {
        start: function () {
          ...
          i.length &&
            ((t = parseInt(e(i[0]).css("zIndex"), 10) || 0),
            e(i).each(function (n) {
    ...
    e.widget("ui.droppable", {
      ...
      _create: function () {
        ...
        (this.isover = !1),
          ...
          (e.ui.ddmanager.droppables[n.scope] =
            e.ui.ddmanager.droppables[n.scope] || []),
      ...
      _drop: function (t, n) {
        var i = n || e.ui.ddmanager.current,
          o = !1;
        return i && (i.currentItem || i.element)[0] !== this.element[0]
          ? (this.element
        ...
        switch (i) {
          ...
          case "intersect":
            return (
              ...
              l - e.helperProportions.width / 2 < p &&
              d < a + e.helperProportions.height / 2 &&
              c - e.helperProportions.height / 2 < h
            );
          case "pointer":
            return (
              (o =
              ...
              n(r, d, t.proportions().height) && n(o, u, t.proportions().width)
            );
          case "touch":
            return (
              ((a >= d && h >= a) || (c >= d && h >= c) || (d > a && c > h)) &&
              ((s >= u && p >= s) || (l >= u && p >= l) || (u > s && l > p))
            );
          default:
            return !1;
        }
                  ...
                  a &&
                    (this.options.greedy &&
                      ...
                      (r = this.element
                        ...
                        .filter(function () {
                          return (
                            e.data(this, "ui-droppable").options.scope === o
                          );
                        })),
                      r.length &&
                        ((i = e.data(r[0], "ui-droppable")),
