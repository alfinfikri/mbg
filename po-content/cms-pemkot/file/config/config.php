...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => str_replace('/po-content/cms-pemkot/file/dialog.php', '', explode('?', $_SERVER['REQUEST_URI'], 2)[0]).'/po-content/uploads/',
	/*
	|--------------------------------------------------------------------------
	...
	*/
	...
	'ext_file'                                => array( 'doc', 'docx', 'rtf', 'pdf', 'xls', 'xlsx', 'ppt', 'pptx'), //Files
	...
	*******************/
	...
	'file_number_limit_js'                    => 24,

	//**********************
	// Hidden files and folders
	//**********************
	// set the names of any folders you want hidden (eg "hidden_folder1", "hidden_folder2" ) Remember all folders with these names will be hidden (you can set any exceptions in config.php files on folders)
	// 'hidden_folders'                          => array( 'medium','users'),
...
// tambahan disable save image di ajax call
