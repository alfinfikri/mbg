...
class BackendController extends Controller
{
    ...
    public function index()
    {
		...
		return view('backend.dashboard', compact('post', 'category', 'tag', 'sppg', 'sekolah', 'aduan', 'menu', 'theme', 'user', 'populars'));
    }
    ...
    public function analytics()
    {
		...
		$fetchTotalVisitorsAndPageViews = $analytic->fetchVisitorsAndPageViews(Period::days(7));
