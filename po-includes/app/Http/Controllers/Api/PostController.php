...
class PostController extends Controller
{
    ...
    public function get(Request $request)
    {
        ...
        $query = Post::with(['category:id,parent,title,seotitle,picture', 'createdBy:id,name,picture', 'updatedBy:id,name,picture'])->withCount('comments')->where('active', 'Y');
        ...
        foreach($posts as $post){
            ...
            if($post->picture != null) {
                ...
                $post->picture = getPicture($post->picture, null, $post->updated_by);
            }
        }
        if($posts) {
            // Hidden key
    ...
    {
        $post = Post::where('id',  $id)->with(['category:id,parent,title,seotitle,picture', 'createdBy:id,name,picture', 'updatedBy:id,name,picture'])->withCount('comments')->where('active', 'Y')->first();
        if(!$post){
    ...
    public function related(Request $request, $id)
    {
        ...
        $query = Post::with(['category:id,parent,title,seotitle,picture', 'createdBy:id,name,picture', 'updatedBy:id,name,picture'])
            ->withCount('comments')
            ->where('active', 'Y')
