@extends('layouts.app')
@section('title', __('banner.edit_title'))
...
@section('content')
		...
		<div>
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb breadcrumb-style1 mg-b-10">
					...
					<li class="breadcrumb-item active" aria-current="page">{{ __('banner.edit_title') }}</li>
				</ol>
			</nav>
			<h4 class="mg-b-0 tx-spacing--1">{{ __('banner.edit_title') }}</h4>
		</div>
	...
	<div class="card">
		{!! Form::model($banner, [
			'method' => 'PATCH',
			'url' => ['/dashboard/banner', Hashids::encode($banner->id)],
