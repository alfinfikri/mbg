...
<div class="form-group">
	...
	<div class="input-group">
	 <input class="date form-control" type="text" name="tanggal" value="{{ !empty($gallery->tanggal) ? $gallery->tanggal : null }}" placeholder="{{ date('Y-m-d') }}" onkeydown="return false" required>
	</div>
