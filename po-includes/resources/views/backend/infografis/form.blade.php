<div class="form-group">
	{!! Form::label('gambar', __('infografis.gambar').' *', ['class' => 'control-label']) !!}
...
<div class="form-group">
	...
	<div class="input-group">
	 <input class="date form-control" type="text" name="tanggal" value="{{ !empty($infografis->tanggal) ? $infografis->tanggal : null }}" placeholder="{{ date('Y-m-d') }}" onkeydown="return false" required>
	</div>
	{!! $errors->first('tanggal', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group">
	{!! Form::label('keterangan', __('infografis.keterangan'), ['class' => 'control-label']) !!}
