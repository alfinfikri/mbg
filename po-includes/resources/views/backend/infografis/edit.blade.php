@extends('layouts.app')
@section('title', __('infografis.edit_title'))
...
@section('content')
		...
		<div>
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb breadcrumb-style1 mg-b-10">
					...
					<li class="breadcrumb-item active" aria-current="page">{{ __('infografis.edit_title') }}</li>
				</ol>
			</nav>
			<h4 class="mg-b-0 tx-spacing--1">{{ __('infografis.edit_title') }}</h4>
		</div>
	...
	<div class="card">
		{!! Form::model($infografis, [
			'method' => 'PATCH',
			'url' => ['/dashboard/infografis', Hashids::encode($infografis->id)],
			...
			<div class="card-body pd-b-0">
				...
				@include ('backend.infografis.form', ['formMode' => 'edit'])
			</div>
