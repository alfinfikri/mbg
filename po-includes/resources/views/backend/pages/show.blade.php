			...
			<div class="table-responsive">
				<table class="table table-striped">
					<tbody>
						...
						<tr>
							<th>{{ __('pages.content') }}</th><td> {!! html_entity_decode($pages->content) !!} </td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								@if($pages->created_at == null) 
								- 
								@else 
								{{ date('d F Y H:i', strtotime($pages->created_at)) }} 
								@endif
							</td>
						</tr>
						<tr>
							...
							<td>
								@if($pages->updated_at == null) 
								- 
								@else 
								{{ date('d F Y H:i', strtotime($pages->updated_at)) }} 
								@endif
							</td>
						</tr>
					</tbody>
