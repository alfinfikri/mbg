...
<head>
   ...
   <title>Error 404 - SerangKota</title>
...
<body>
   ...
   <div class="error-page d-flex align-items-center justify-content-center">
    <div class="error-container text-center p-4">
        ...
        <h2 class="display-6 error-message mb-3">Lake Halaman Lur!</h2>
        <p class="lead error-message mb-5">Sepertinya kami tidak dapat menemukan halaman yang Anda cari.</p>
