...
<head>
   ...
   <title>Error 500 - SerangKota</title>
...
<body>
   ...
   <div class="error-page d-flex align-items-center justify-content-center">
    <div class="error-container text-center p-4">
        ...
        <h2 class="display-6 error-message mb-3">Error 500 Lur!</h2>
        <p class="lead error-message mb-5">Status 500 menyatakan ada kesalahan konfigurasi pada server dan code ada yang error lur !.</p>
