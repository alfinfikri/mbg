...
<head>
    ...
    <meta name="author" content="CMS Madani" />
...
<body>
	<header class="navbar navbar-header navbar-header-fixed">
		<div class="navbar-brand">
			<a href="{{ url('/') }}" class="df-logo pt-2"><img src="{{ asset('po-content/uploads/' . getSetting('logo')) }}" width="80px"></a>
		</div>
	...
	<footer class="footer">
		<div>
			<span>&copy; 2023 - {{ date('Y') }} IT Diskominfo Kota Serang.{{ config('app.version') }}</span>
		</div>
		<div>
			<nav class="nav">
			</nav>
