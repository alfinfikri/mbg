...
<head>
	...
	<meta name="description" content="@yield('title')" />
  	...
  	<meta name="author" content="Serang Kota - Diskominfo Kota Serang" />
	...
	<link href="{{ asset('po-content/cms-pemkot/file/fancybox/jquery.fancybox.css') }}" rel="stylesheet">
...
<body>
	<aside class="aside aside-fixed">
        <div class="aside-header">
            <a href="{{ url('/dashboard') }}" class="aside-logo pt-2"><img src="{{ asset('po-content/uploads/'.getSetting('logo')) }}" width="100px"></a>
				...
				<div class="navbar-right pr-3">
					<div class="dropdown dropdown-profile">
						...
						<div class="dropdown-menu dropdown-menu-right tx-13">
							...
							@if (Auth::user()->hasRole('superadmin') || Auth::user()->hasRole('superadmin 2') || Auth::user()->hasRole('admin'))
							...
							<a href="javascript:void(0);" id="logout-btn" class="dropdown-item">
								<i data-feather="log-out"></i> {{ __('general.sign_out') }}
							</a>
							<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
								@csrf
							</form>
	...
	<script src="{{ asset('po-content/cms-pemkot/file/fancybox/jquery.fancybox.js') }}"></script>
		...
		document.addEventListener('click', function(e) {
			if (e.target.closest('#logout-btn')) {
				...
				Swal.fire({
					...
					text: "Jika Iya ingin Logout Klik Button!",
	...
	<script src="{{ asset('po-admin/assets/js/serangkota-main.js') }}"></script>
</body>
</html>